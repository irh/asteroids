...
var _p1=_p0;return A2($Task.onError,_p1._0(value),function(_p2){return $Task.succeed({ctor:"_Tuple0"})})});var Message=function(a){return{ctor:"Message",_0:a}};var message=F2(function(_p3,value){var _p4=_p3;return Message(_p4._0(value))});var mailbox=$Native$Signal.mailbox;var Address=function(a){return{ctor:"Address",_0:a}};var forwardTo=F2(function(_p5,f){var _p6=_p5;return Address(function(x){return _p6._0(f(x))})});var Mailbox=F2(function(a,b){return{address:a,signal:b}});var sampleOn=$Native$Signal.sampleOn;var dropRepeats=$Native$Signal.dropRepeats;var filterMap=$Native$Signal.filterMap;var filter=F3(function(isOk,base,signal){return A3(filterMap,function(value){return isOk(value)?$Maybe.Just(value):$Maybe.Nothing},base,signal)});var merge=F2(function(left,right){return A3($Native$Signal.genericMerge,$Basics.always,left,right)});var mergeMany=function(signalList){var _p7=$List.reverse(signalList);if(_p7.ctor==="[]"){return _U.crashCase("Signal",{start:{line:184,column:3},end:{line:189,column:40}},_p7)("mergeMany was given an empty list!")}else{return A3($List.foldl,merge,_p7._0,_p7._1)}};var foldp=$Native$Signal.foldp;var map5=$Native$Signal.map5;var map4=$Native$Signal.map4;var map3=$Native$Signal.map3;var map2=$Native$Signal.map2;var map=$Native$Signal.map;var constant=$Native$Signal.constant;var Signal={ctor:"Signal"};return _elm.Signal.values={_op:_op,merge:merge,mergeMany:mergeMany,map:map,map2:map2,map3:map3,map4:map4,map5:map5,constant:constant,dropRepeats:dropRepeats,filter:filter,filterMap:filterMap,sampleOn:sampleOn,foldp:foldp,mailbox:mailbox,send:send,message:message,forwardTo:forwardTo,Mailbox:Mailbox}};Elm.Signal=Elm.Signal||{};Elm.Signal.Discrete=Elm.Signal.Discrete||{};Elm.Signal.Discrete.make=function(_elm){"use strict";_elm.Signal=_elm.Signal||{};_elm.Signal.Discrete=_elm.Signal.Discrete||{};if(_elm.Signal.Discrete.values)return _elm.Signal.Discrete.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var folde=F3(function(step,base,evt){return A3($Signal.foldp,F2(function(_p0,b){return step(b)}),base,evt)});var es=$Signal.map($Basics.always({ctor:"_Tuple0"}));var whenEqual=F2(function(value,input){var keepIf=$Signal.filter;var matchEvent=A3(keepIf,F2(function(x,y){return _U.eq(x,y)})(value),value,input);return es(matchEvent)});var whenChangeTo=F2(function(value,input){return A2(whenEqual,value,$Signal.dropRepeats(input))});var whenChange=function(input){return es($Signal.dropRepeats(input))};return _elm.Signal.Discrete.values={_op:_op,es:es,whenEqual:whenEqual,whenChange:whenChange,whenChangeTo:whenChangeTo,folde:folde}};Elm.Signal=Elm.Signal||{};Elm.Signal.Extra=Elm.Signal.Extra||{};Elm.Signal.Extra.make=function(_elm){"use strict";_elm.Signal=_elm.Signal||{};_elm.Signal.Extra=_elm.Signal.Extra||{};if(_elm.Signal.Extra.values)return _elm.Signal.Extra.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var unsafeFromJust=function(maybe){var _p0=maybe;if(_p0.ctor==="Just"){return _p0._0}else{return _U.crashCase("Signal.Extra",{start:{line:510,column:3},end:{line:515,column:59}},_p0)("This case should have been unreachable")}};var passiveMap2=F2(function(func,a){return function(_p2){return A3($Signal.map2,func,a,A2($Signal.sampleOn,a,_p2))}});var withPassive=passiveMap2(F2(function(x,y){return x(y)}));var combine=A2($List.foldr,$Signal.map2(F2(function(x,y){return A2($List._op["::"],x,y)})),$Signal.constant(_U.list([])));var mergeMany=F2(function(original,others){return A3($List.foldl,$Signal.merge,original,others)});var filter=function(initial){return A2($Signal.filterMap,$Basics.identity,initial)};var keepIf=$Signal.filter;var runBuffer$=F3(function(l,n,input){var f=F2(function(inp,prev){var l=$List.length(prev);return _U.cmp(l,n)<0?A2($Basics._op["++"],prev,_U.list([inp])):A2($Basics._op["++"],A2($List.drop,l-n+1,prev),_U.list([inp]))});return A3($Signal.foldp,f,l,input)});var runBuffer=runBuffer$(_U.list([]));var initSignal=function(s){return A2($Signal.sampleOn,$Signal.constant({ctor:"_Tuple0"}),s)};var zip4=$Signal.map4(F4(function(v0,v1,v2,v3){return{ctor:"_Tuple4",_0:v0,_1:v1,_2:v2,_3:v3}}));var zip3=$Signal.map3(F3(function(v0,v1,v2){return{ctor:"_Tuple3",_0:v0,_1:v1,_2:v2}}));var zip=$Signal.map2(F2(function(v0,v1){return{ctor:"_Tuple2",_0:v0,_1:v1}}));var keepWhen=F3(function(boolSig,a,aSig){return A2($Signal.map,$Basics.snd,A3(keepIf,$Basics.fst,{ctor:"_Tuple2",_0:true,_1:a},A2($Signal.sampleOn,aSig,A2(zip,boolSig,aSig))))});var sampleWhen=F3(function(bs,def,sig){return A2($Signal.map,$Basics.snd,A3(keepIf,$Basics.fst,{ctor:"_Tuple2",_0:true,_1:def},A2(zip,bs,sig)))});var andMap=$Signal.map2(F2(function(x,y){return x(y)}));_op["~"]=andMap;var applyMany=F2(function(fs,l){return A2(_op["~"],fs,combine(l))});_op["~>"]=$Basics.flip($Signal.map);var foldpWith=F4(function(unpack,step,init,input){var step$=F2(function(a,_p3){var _p4=_p3;return unpack(A2(step,a,_p4._1))});return A2(_op["~>"],A3($Signal.foldp,step$,init,input),$Basics.fst)});_op["<~"]=$Signal.map;var unzip=function(pairS){return{ctor:"_Tuple2",_0:A2(_op["<~"],$Basics.fst,pairS),_1:A2(_op["<~"],$Basics.snd,pairS)}};var unzip3=function(pairS){return{ctor:"_Tuple3",_0:A2(_op["<~"],function(_p5){var _p6=_p5;return _p6._0},pairS),_1:A2(_op["<~"],function(_p7){var _p8=_p7;return _p8._1},pairS),_2:A2(_op["<~"],function(_p9){var _p10=_p9;return _p10._2},pairS)}};var unzip4=function(pairS){return{ctor:"_Tuple4",_0:A2(_op["<~"],function(_p11){var _p12=_p11;return _p12._0},pairS),_1:A2(_op["<~"],function(_p13){var _p14=_p13;return _p14._1},pairS),_2:A2(_op["<~"],function(_p15){var _p16=_p15;return _p16._2},pairS),_3:A2(_op["<~"],function(_p17){var _p18=_p17;return _p18._3},pairS)}};var foldp$=F3(function(fun,initFun,input){var fun$=F2(function(_p19,mb){var _p20=_p19;return $Maybe.Just(A2(fun,_p20._0,A2($Maybe.withDefault,_p20._1,mb)))});var initial=A2(_op["~>"],initSignal(input),initFun);var rest=A3($Signal.foldp,fun$,$Maybe.Nothing,A2(zip,input,initial));return A2(_op["<~"],unsafeFromJust,A2($Signal.merge,A2(_op["<~"],$Maybe.Just,initial),rest))});var deltas=function(signal){var initial=function(value){return{ctor:"_Tuple2",_0:value,_1:value}};var step=F2(function(value,delta){return{ctor:"_Tuple2",_0:$Basics.snd(delta),_1:value}});return A3(foldp$,step,initial,signal)};var foldps=F3(function(f,bs,aS){return A2(_op["<~"],$Basics.fst,A3($Signal.foldp,F2(function(a,_p21){var _p22=_p21;return A2(f,a,_p22._1)}),bs,aS))});var delayRound=F2(function(b,bS){return A3(foldps,F2(function($new,old){return{ctor:"_Tuple2",_0:old,_1:$new}}),{ctor:"_Tuple2",_0:b,_1:b},bS)});var filterFold=F2(function(f,initial){var f$=F2(function(a,s){var res=A2(f,a,s);return{ctor:"_Tuple2",_0:res,_1:A2($Maybe.withDefault,s,res)}});return function(_p23){return A2(filter,initial,A3(foldps,f$,{ctor:"_Tuple2",_0:$Maybe.Just(initial),_1:initial},_p23))}});var foldps$=F3(function(f,iF,aS){return A2(_op["<~"],$Basics.fst,A3(foldp$,F2(function(a,_p24){var _p25=_p24;return A2(f,a,_p25._1)}),iF,aS))});var switchHelper=F4(function(filter,b,l,r){var lAndR=A2($Signal.merge,A3(filter,b,$Maybe.Nothing,A2(_op["<~"],$Maybe.Just,l)),A3(filter,A2(_op["<~"],$Basics.not,b),$Maybe.Nothing,A2(_op["<~"],$Maybe.Just,r)));var base=A2(_op["~"],A2(_op["~"],A2(_op["<~"],F3(function(bi,li,ri){return $Maybe.Just(bi?li:ri)}),initSignal(b)),initSignal(l)),initSignal(r));return A2(_op["<~"],unsafeFromJust,A2($Signal.merge,base,lAndR))});var switchWhen=F3(function(b,l,r){return A4(switchHelper,keepWhen,b,l,r)});var switchSample=F3(function(b,l,r){return A4(switchHelper,sampleWhen,b,l,r)});var keepThen=F3(function(choice,base,signal){return A3(switchSample,choice,signal,$Signal.constant(base))});var keepWhenI=F2(function(fs,s){return A2(_op["~>"],A3(keepWhen,A2($Signal.merge,$Signal.constant(true),fs),$Maybe.Nothing,A2(_op["<~"],$Maybe.Just,s)),unsafeFromJust)});var fairMerge=F3(function(resolve,left,right){var merged=A2($Signal.merge,left,right);var boolRight=A2(_op["<~"],$Basics.always(false),right);var boolLeft=A2(_op["<~"],$Basics.always(true),left);var bothUpdated=A2(_op["~"],A2(_op["<~"],F2(function(x,y){return!_U.eq(x,y)}),A2($Signal.merge,boolLeft,boolRight)),A2($Signal.merge,boolRight,boolLeft));var keep=keepWhenI(bothUpdated);var resolved=A2(_op["~"],A2(_op["<~"],resolve,keep(left)),keep(right));return A2($Signal.merge,resolved,merged)});var mapMany=F2(function(f,l){return A2(_op["<~"],f,combine(l))});return _elm.Signal.Extra.values={_op:_op,andMap:andMap,zip:zip,zip3:zip3,zip4:zip4,unzip:unzip,unzip3:unzip3,unzip4:unzip4,foldp$:foldp$,foldps:foldps,foldps$:foldps$,runBuffer:runBuffer,runBuffer$:runBuffer$,deltas:deltas,delayRound:delayRound,keepIf:keepIf,keepWhen:keepWhen,sampleWhen:sampleWhen,switchWhen:switchWhen,keepWhenI:keepWhenI,switchSample:switchSample,keepThen:keepThen,filter:filter,filterFold:filterFold,fairMerge:fairMerge,mergeMany:mergeMany,combine:combine,mapMany:mapMany,applyMany:applyMany,passiveMap2:passiveMap2,withPassive:withPassive}};Elm.Native.Time={};Elm.Native.Time.make=function(localRuntime){localRuntime.Native=localRuntime.Native||{};localRuntime.Native.Time=localRuntime.Native.Time||{};if(localRuntime.Native.Time.values){return localRuntime.Native.Time.values}var NS=Elm.Native.Signal.make(localRuntime);var Maybe=Elm.Maybe.make(localRuntime);function fpsWhen(desiredFPS,isOn){var msPerFrame=1e3/desiredFPS;var ticker=NS.input("fps-"+desiredFPS,null);function notifyTicker(){localRuntime.notify(ticker.id,null)}function firstArg(x,y){return x}var input=NS.timestamp(A3(NS.map2,F2(firstArg),NS.dropRepeats(isOn),ticker));var initialState={isOn:false,time:localRuntime.timer.programStart,delta:0};var timeoutId;function update(input,state){var currentTime=input._0;var isOn=input._1;var wasOn=state.isOn;var previousTime=state.time;if(isOn){timeoutId=localRuntime.setTimeout(notifyTicker,msPerFrame)}else if(wasOn){clearTimeout(timeoutId)}return{isOn:isOn,time:currentTime,delta:isOn&&!wasOn?0:currentTime-previousTime}}return A2(NS.map,function(state){return state.delta},A3(NS.foldp,F2(update),update(input.value,initialState),input))}function every(t){var ticker=NS.input("every-"+t,null);function tellTime(){localRuntime.notify(ticker.id,null)}var clock=A2(NS.map,fst,NS.timestamp(ticker));setInterval(tellTime,t);return clock}function fst(pair){return pair._0}function read(s){var t=Date.parse(s);return isNaN(t)?Maybe.Nothing:Maybe.Just(t)}return localRuntime.Native.Time.values={fpsWhen:F2(fpsWhen),every:every,toDate:function(t){return new Date(t)},read:read}};Elm.Time=Elm.Time||{};Elm.Time.make=function(_elm){"use strict";_elm.Time=_elm.Time||{};if(_elm.Time.values)return _elm.Time.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Native$Signal=Elm.Native.Signal.make(_elm),$Native$Time=Elm.Native.Time.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var delay=$Native$Signal.delay;var since=F2(function(time,signal){var stop=A2($Signal.map,$Basics.always(-1),A2(delay,time,signal));var start=A2($Signal.map,$Basics.always(1),signal);var delaydiff=A3($Signal.foldp,F2(function(x,y){return x+y}),0,A2($Signal.merge,start,stop));return A2($Signal.map,F2(function(x,y){return!_U.eq(x,y)})(0),delaydiff)});var timestamp=$Native$Signal.timestamp;var every=$Native$Time.every;var fpsWhen=$Native$Time.fpsWhen;var fps=function(targetFrames){return A2(fpsWhen,targetFrames,$Signal.constant(true))};var inMilliseconds=function(t){return t};var millisecond=1;var second=1e3*millisecond;var minute=60*second;var hour=60*minute;var inHours=function(t){return t/hour};var inMinutes=function(t){return t/minute};var inSeconds=function(t){return t/second};return _elm.Time.values={_op:_op,millisecond:millisecond,second:second,minute:minute,hour:hour,inMilliseconds:inMilliseconds,inSeconds:inSeconds,inMinutes:inMinutes,inHours:inHours,fps:fps,fpsWhen:fpsWhen,every:every,timestamp:timestamp,delay:delay,since:since}};Elm.Signal=Elm.Signal||{};Elm.Signal.Time=Elm.Signal.Time||{};Elm.Signal.Time.make=function(_elm){"use strict";_elm.Signal=_elm.Signal||{};_elm.Signal.Time=_elm.Signal.Time||{};if(_elm.Signal.Time.values)return _elm.Signal.Time.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Signal$Discrete=Elm.Signal.Discrete.make(_elm),$Signal$Extra=Elm.Signal.Extra.make(_elm),$Time=Elm.Time.make(_elm);var _op={};var timestamp=$Time.timestamp;var delay=$Time.delay;var since=$Time.since;var settledAfter=F2(function(delay,sig){var trailing=A2($Signal$Discrete.whenChangeTo,false,A2(since,delay,sig));return A2($Signal.sampleOn,trailing,sig)});var dropWithin=F2(function(delay,sig){var leading=A2($Signal$Discrete.whenChangeTo,true,A2(since,delay,sig));return A2($Signal.sampleOn,leading,sig)});var timestamps=function(s){return A2($Signal$Extra._op["~>"],timestamp(s),$Basics.fst)};var limitRate=F2(function(period,sig){var within=F2(function(newt,oldt){return _U.cmp(newt-oldt,period)>0?newt:oldt});var windowStart=A3($Signal.foldp,within,0,timestamps(sig));return A2($Signal.sampleOn,$Signal$Discrete.whenChange(windowStart),sig)});var startTime=timestamps($Signal.constant({ctor:"_Tuple0"}));var relativeTime=function(s){return A2($Signal$Extra._op["~"],A2($Signal$Extra._op["<~"],F2(function(x,y){return x-y}),s),startTime)};return _elm.Signal.Time.values={_op:_op,limitRate:limitRate,dropWithin:dropWithin,settledAfter:settledAfter,startTime:startTime,relativeTime:relativeTime,since:since,delay:delay,timestamp:timestamp}};Elm.Native.Char={};Elm.Native.Char.make=function(localRuntime){localRuntime.Native=localRuntime.Native||{};localRuntime.Native.Char=localRuntime.Native.Char||{};if(localRuntime.Native.Char.values){return localRuntime.Native.Char.values}var Utils=Elm.Native.Utils.make(localRuntime);return localRuntime.Native.Char.values={fromCode:function(c){return Utils.chr(String.fromCharCode(c))},toCode:function(c){return c.charCodeAt(0)},toUpper:function(c){return Utils.chr(c.toUpperCase())},toLower:function(c){return Utils.chr(c.toLowerCase())},toLocaleUpper:function(c){return Utils.chr(c.toLocaleUpperCase())},toLocaleLower:function(c){return Utils.chr(c.toLocaleLowerCase())}}};Elm.Char=Elm.Char||{};Elm.Char.make=function(_elm){"use strict";_elm.Char=_elm.Char||{};if(_elm.Char.values)return _elm.Char.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Native$Char=Elm.Native.Char.make(_elm);var _op={};var fromCode=$Native$Char.fromCode;var toCode=$Native$Char.toCode;var toLocaleLower=$Native$Char.toLocaleLower;var toLocaleUpper=$Native$Char.toLocaleUpper;var toLower=$Native$Char.toLower;var toUpper=$Native$Char.toUpper;var isBetween=F3(function(low,high,$char){var code=toCode($char);return _U.cmp(code,toCode(low))>-1&&_U.cmp(code,toCode(high))<1});var isUpper=A2(isBetween,_U.chr("A"),_U.chr("Z"));var isLower=A2(isBetween,_U.chr("a"),_U.chr("z"));var isDigit=A2(isBetween,_U.chr("0"),_U.chr("9"));var isOctDigit=A2(isBetween,_U.chr("0"),_U.chr("7"));var isHexDigit=function($char){return isDigit($char)||(A3(isBetween,_U.chr("a"),_U.chr("f"),$char)||A3(isBetween,_U.chr("A"),_U.chr("F"),$char))};return _elm.Char.values={_op:_op,isUpper:isUpper,isLower:isLower,isDigit:isDigit,isOctDigit:isOctDigit,isHexDigit:isHexDigit,toUpper:toUpper,toLower:toLower,toLocaleUpper:toLocaleUpper,toLocaleLower:toLocaleLower,toCode:toCode,fromCode:fromCode}};Elm.Native.String={};Elm.Native.String.make=function(localRuntime){localRuntime.Native=localRuntime.Native||{};localRuntime.Native.String=localRuntime.Native.String||{};if(localRuntime.Native.String.values){return localRuntime.Native.String.values}if("values"in Elm.Native.String){return localRuntime.Native.String.values=Elm.Native.String.values}var Char=Elm.Char.make(localRuntime);var List=Elm.Native.List.make(localRuntime);var Maybe=Elm.Maybe.make(localRuntime);var Result=Elm.Result.make(localRuntime);var Utils=Elm.Native.Utils.make(localRuntime);function isEmpty(str){return str.length===0}function cons(chr,str){return chr+str}function uncons(str){var hd=str[0];if(hd){return Maybe.Just(Utils.Tuple2(Utils.chr(hd),str.slice(1)))}return Maybe.Nothing}function append(a,b){return a+b}function concat(strs){return List.toArray(strs).join("")}function length(str){return str.length}function map(f,str){var out=str.split("");for(var i=out.length;i--;){out[i]=f(Utils.chr(out[i]))}return out.join("")}function filter(pred,str){return str.split("").map(Utils.chr).filter(pred).join("")}function reverse(str){return str.split("").reverse().join("")}function foldl(f,b,str){var len=str.length;for(var i=0;i<len;++i){b=A2(f,Utils.chr(str[i]),b)}return b}function foldr(f,b,str){for(var i=str.length;i--;){b=A2(f,Utils.chr(str[i]),b)}return b}function split(sep,str){return List.fromArray(str.split(sep))}function join(sep,strs){return List.toArray(strs).join(sep)}function repeat(n,str){var result="";while(n>0){if(n&1){result+=str}n>>=1,str+=str}return result}function slice(start,end,str){return str.slice(start,end)}function left(n,str){return n<1?"":str.slice(0,n)}function right(n,str){return n<1?"":str.slice(-n)}function dropLeft(n,str){return n<1?str:str.slice(n)}function dropRight(n,str){return n<1?str:str.slice(0,-n)}function pad(n,chr,str){var half=(n-str.length)/2;return repeat(Math.ceil(half),chr)+str+repeat(half|0,chr)}function padRight(n,chr,str){return str+repeat(n-str.length,chr)}function padLeft(n,chr,str){return repeat(n-str.length,chr)+str}function trim(str){return str.trim()}function trimLeft(str){return str.replace(/^\s+/,"")}function trimRight(str){return str.replace(/\s+$/,"")}function words(str){return List.fromArray(str.trim().split(/\s+/g))}function lines(str){return List.fromArray(str.split(/\r\n|\r|\n/g))}function toUpper(str){return str.toUpperCase()}function toLower(str){return str.toLowerCase()}function any(pred,str){for(var i=str.length;i--;){if(pred(Utils.chr(str[i]))){return true}}return false}function all(pred,str){for(var i=str.length;i--;){if(!pred(Utils.chr(str[i]))){return false}}return true}function contains(sub,str){return str.indexOf(sub)>-1}function startsWith(sub,str){return str.indexOf(sub)===0}function endsWith(sub,str){return str.length>=sub.length&&str.lastIndexOf(sub)===str.length-sub.length}function indexes(sub,str){var subLen=sub.length;var i=0;var is=[];while((i=str.indexOf(sub,i))>-1){is.push(i);i=i+subLen}return List.fromArray(is)}function toInt(s){var len=s.length;if(len===0){return Result.Err("could not convert string '"+s+"' to an Int")}var start=0;if(s[0]==="-"){if(len===1){return Result.Err("could not convert string '"+s+"' to an Int")}start=1}for(var i=start;i<len;++i){if(!Char.isDigit(s[i])){return Result.Err("could not convert string '"+s+"' to an Int")}}return Result.Ok(parseInt(s,10))}function toFloat(s){var len=s.length;if(len===0){return Result.Err("could not convert string '"+s+"' to a Float")}var start=0;if(s[0]==="-"){if(len===1){return Result.Err("could not convert string '"+s+"' to a Float")}start=1}var dotCount=0;for(var i=start;i<len;++i){if(Char.isDigit(s[i])){continue}if(s[i]==="."){dotCount+=1;if(dotCount<=1){continue}}return Result.Err("could not convert string '"+s+"' to a Float")}return Result.Ok(parseFloat(s))}function toList(str){return List.fromArray(str.split("").map(Utils.chr))}function fromList(chars){return List.toArray(chars).join("")}return Elm.Native.String.values={isEmpty:isEmpty,cons:F2(cons),uncons:uncons,append:F2(append),concat:concat,length:length,map:F2(map),filter:F2(filter),reverse:reverse,foldl:F3(foldl),foldr:F3(foldr),split:F2(split),join:F2(join),repeat:F2(repeat),slice:F3(slice),left:F2(left),right:F2(right),dropLeft:F2(dropLeft),dropRight:F2(dropRight),pad:F3(pad),padLeft:F3(padLeft),padRight:F3(padRight),trim:trim,trimLeft:trimLeft,trimRight:trimRight,words:words,lines:lines,toUpper:toUpper,toLower:toLower,any:F2(any),all:F2(all),contains:F2(contains),startsWith:F2(startsWith),endsWith:F2(endsWith),indexes:F2(indexes),toInt:toInt,toFloat:toFloat,toList:toList,fromList:fromList}};Elm.String=Elm.String||{};Elm.String.make=function(_elm){"use strict";_elm.String=_elm.String||{};if(_elm.String.values)return _elm.String.values;var _U=Elm.Native.Utils.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Native$String=Elm.Native.String.make(_elm),$Result=Elm.Result.make(_elm);var _op={};var fromList=$Native$String.fromList;var toList=$Native$String.toList;var toFloat=$Native$String.toFloat;var toInt=$Native$String.toInt;var indices=$Native$String.indexes;var indexes=$Native$String.indexes;var endsWith=$Native$String.endsWith;var startsWith=$Native$String.startsWith;var contains=$Native$String.contains;var all=$Native$String.all;var any=$Native$String.any;var toLower=$Native$String.toLower;var toUpper=$Native$String.toUpper;var lines=$Native$String.lines;var words=$Native$String.words;var trimRight=$Native$String.trimRight;var trimLeft=$Native$String.trimLeft;var trim=$Native$String.trim;var padRight=$Native$String.padRight;var padLeft=$Native$String.padLeft;var pad=$Native$String.pad;var dropRight=$Native$String.dropRight;var dropLeft=$Native$String.dropLeft;var right=$Native$String.right;var left=$Native$String.left;var slice=$Native$String.slice;var repeat=$Native$String.repeat;var join=$Native$String.join;var split=$Native$String.split;var foldr=$Native$String.foldr;var foldl=$Native$String.foldl;var reverse=$Native$String.reverse;var filter=$Native$String.filter;var map=$Native$String.map;var length=$Native$String.length;var concat=$Native$String.concat;var append=$Native$String.append;var uncons=$Native$String.uncons;var cons=$Native$String.cons;var fromChar=function($char){return A2(cons,$char,"")};var isEmpty=$Native$String.isEmpty;return _elm.String.values={_op:_op,isEmpty:isEmpty,length:length,reverse:reverse,repeat:repeat,cons:cons,uncons:uncons,fromChar:fromChar,append:append,concat:concat,split:split,join:join,words:words,lines:lines,slice:slice,left:left,right:right,dropLeft:dropLeft,dropRight:dropRight,contains:contains,startsWith:startsWith,endsWith:endsWith,indexes:indexes,indices:indices,toInt:toInt,toFloat:toFloat,toList:toList,fromList:fromList,toUpper:toUpper,toLower:toLower,pad:pad,padLeft:padLeft,padRight:padRight,trim:trim,trimLeft:trimLeft,trimRight:trimRight,map:map,filter:filter,foldl:foldl,foldr:foldr,any:any,all:all}};Elm.Dict=Elm.Dict||{};Elm.Dict.make=function(_elm){"use strict";_elm.Dict=_elm.Dict||{};if(_elm.Dict.values)return _elm.Dict.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Native$Debug=Elm.Native.Debug.make(_elm),$String=Elm.String.make(_elm);var _op={};var foldr=F3(function(f,acc,t){foldr:while(true){var _p0=t;if(_p0.ctor==="RBEmpty_elm_builtin"){return acc}else{var _v1=f,_v2=A3(f,_p0._1,_p0._2,A3(foldr,f,acc,_p0._4)),_v3=_p0._3;f=_v1;acc=_v2;t=_v3;continue foldr}}});var keys=function(dict){return A3(foldr,F3(function(key,value,keyList){return A2($List._op["::"],key,keyList)}),_U.list([]),dict)};var values=function(dict){return A3(foldr,F3(function(key,value,valueList){return A2($List._op["::"],value,valueList)}),_U.list([]),dict)};var toList=function(dict){return A3(foldr,F3(function(key,value,list){return A2($List._op["::"],{ctor:"_Tuple2",_0:key,_1:value},list)}),_U.list([]),dict)};var foldl=F3(function(f,acc,dict){foldl:while(true){var _p1=dict;if(_p1.ctor==="RBEmpty_elm_builtin"){return acc}else{var _v5=f,_v6=A3(f,_p1._1,_p1._2,A3(foldl,f,acc,_p1._3)),_v7=_p1._4;f=_v5;acc=_v6;dict=_v7;continue foldl}}});var reportRemBug=F4(function(msg,c,lgot,rgot){return $Native$Debug.crash($String.concat(_U.list(["Internal red-black tree invariant violated, expected ",msg," and got ",$Basics.toString(c),"/",lgot,"/",rgot,"\nPlease report this bug to <https://github.com/elm-lang/core/issues>"])))});var isBBlack=function(dict){var _p2=dict;_v8_2:do{if(_p2.ctor==="RBNode_elm_builtin"){if(_p2._0.ctor==="BBlack"){return true}else{break _v8_2}}else{if(_p2._0.ctor==="LBBlack"){return true}else{break _v8_2}}}while(false);return false};var Same={ctor:"Same"};var Remove={ctor:"Remove"};var Insert={ctor:"Insert"};var sizeHelp=F2(function(n,dict){sizeHelp:while(true){var _p3=dict;if(_p3.ctor==="RBEmpty_elm_builtin"){return n}else{var _v10=A2(sizeHelp,n+1,_p3._4),_v11=_p3._3;n=_v10;dict=_v11;continue sizeHelp}}});var size=function(dict){return A2(sizeHelp,0,dict)};var get=F2(function(targetKey,dict){get:while(true){var _p4=dict;if(_p4.ctor==="RBEmpty_elm_builtin"){return $Maybe.Nothing}else{var _p5=A2($Basics.compare,targetKey,_p4._1);switch(_p5.ctor){case"LT":var _v14=targetKey,_v15=_p4._3;targetKey=_v14;dict=_v15;continue get;case"EQ":return $Maybe.Just(_p4._2);default:var _v16=targetKey,_v17=_p4._4;targetKey=_v16;dict=_v17;continue get}}}});var member=F2(function(key,dict){var _p6=A2(get,key,dict);if(_p6.ctor==="Just"){return true}else{return false}});var maxWithDefault=F3(function(k,v,r){maxWithDefault:while(true){var _p7=r;if(_p7.ctor==="RBEmpty_elm_builtin"){return{ctor:"_Tuple2",_0:k,_1:v}}else{var _v20=_p7._1,_v21=_p7._2,_v22=_p7._4;k=_v20;v=_v21;r=_v22;continue maxWithDefault}}});var RBEmpty_elm_builtin=function(a){return{ctor:"RBEmpty_elm_builtin",_0:a}};var RBNode_elm_builtin=F5(function(a,b,c,d,e){return{ctor:"RBNode_elm_builtin",_0:a,_1:b,_2:c,_3:d,_4:e}});var LBBlack={ctor:"LBBlack"};var LBlack={ctor:"LBlack"};var empty=RBEmpty_elm_builtin(LBlack);var isEmpty=function(dict){return _U.eq(dict,empty)};var map=F2(function(f,dict){var _p8=dict;if(_p8.ctor==="RBEmpty_elm_builtin"){return RBEmpty_elm_builtin(LBlack)}else{var _p9=_p8._1;return A5(RBNode_elm_builtin,_p8._0,_p9,A2(f,_p9,_p8._2),A2(map,f,_p8._3),A2(map,f,_p8._4))}});var NBlack={ctor:"NBlack"};var BBlack={ctor:"BBlack"};var Black={ctor:"Black"};var ensureBlackRoot=function(dict){var _p10=dict;if(_p10.ctor==="RBNode_elm_builtin"&&_p10._0.ctor==="Red"){return A5(RBNode_elm_builtin,Black,_p10._1,_p10._2,_p10._3,_p10._4)}else{return dict}};var blackish=function(t){var _p11=t;if(_p11.ctor==="RBNode_elm_builtin"){var _p12=_p11._0;return _U.eq(_p12,Black)||_U.eq(_p12,BBlack)}else{return true}};var blacken=function(t){var _p13=t;if(_p13.ctor==="RBEmpty_elm_builtin"){return RBEmpty_elm_builtin(LBlack)}else{return A5(RBNode_elm_builtin,Black,_p13._1,_p13._2,_p13._3,_p13._4)}};var Red={ctor:"Red"};var moreBlack=function(color){var _p14=color;switch(_p14.ctor){case"Black":return BBlack;case"Red":return Black;case"NBlack":return Red;default:return $Native$Debug.crash("Can't make a double black node more black!")}};var lessBlack=function(color){var _p15=color;switch(_p15.ctor){case"BBlack":return Black;case"Black":return Red;case"Red":return NBlack;default:return $Native$Debug.crash("Can't make a negative black node less black!")}};var lessBlackTree=function(dict){var _p16=dict;if(_p16.ctor==="RBNode_elm_builtin"){return A5(RBNode_elm_builtin,lessBlack(_p16._0),_p16._1,_p16._2,_p16._3,_p16._4)}else{return RBEmpty_elm_builtin(LBlack)}};var balancedTree=function(col){return function(xk){return function(xv){return function(yk){return function(yv){return function(zk){return function(zv){return function(a){return function(b){return function(c){return function(d){return A5(RBNode_elm_builtin,lessBlack(col),yk,yv,A5(RBNode_elm_builtin,Black,xk,xv,a,b),A5(RBNode_elm_builtin,Black,zk,zv,c,d))}}}}}}}}}}};var redden=function(t){var _p17=t;if(_p17.ctor==="RBEmpty_elm_builtin"){return $Native$Debug.crash("can't make a Leaf red")}else{return A5(RBNode_elm_builtin,Red,_p17._1,_p17._2,_p17._3,_p17._4)}};var balanceHelp=function(tree){var _p18=tree;_v31_6:do{_v31_5:do{_v31_4:do{_v31_3:do{_v31_2:do{_v31_1:do{_v31_0:do{if(_p18.ctor==="RBNode_elm_builtin"){if(_p18._3.ctor==="RBNode_elm_builtin"){if(_p18._4.ctor==="RBNode_elm_builtin"){switch(_p18._3._0.ctor){case"Red":switch(_p18._4._0.ctor){case"Red":if(_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Red"){break _v31_0}else{if(_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Red"){break _v31_1}else{if(_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Red"){break _v31_2}else{if(_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Red"){break _v31_3}else{break _v31_6}}}}case"NBlack":if(_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Red"){break _v31_0}else{if(_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Red"){break _v31_1}else{if(_p18._0.ctor==="BBlack"&&_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Black"&&_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Black"){break _v31_4}else{break _v31_6}}}default:if(_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Red"){break _v31_0}else{if(_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Red"){break _v31_1}else{break _v31_6}}}case"NBlack":switch(_p18._4._0.ctor){case"Red":if(_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Red"){break _v31_2}else{if(_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Red"){break _v31_3}else{if(_p18._0.ctor==="BBlack"&&_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Black"&&_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Black"){break _v31_5}else{break _v31_6}}}case"NBlack":if(_p18._0.ctor==="BBlack"){if(_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Black"&&_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Black"){break _v31_4}else{if(_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Black"&&_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Black"){break _v31_5}else{break _v31_6}}}else{break _v31_6}default:if(_p18._0.ctor==="BBlack"&&_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Black"&&_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Black"){break _v31_5}else{break _v31_6}}default:switch(_p18._4._0.ctor){case"Red":if(_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Red"){break _v31_2}else{if(_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Red"){break _v31_3}else{break _v31_6}}case"NBlack":if(_p18._0.ctor==="BBlack"&&_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Black"&&_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Black"){break _v31_4}else{break _v31_6}default:break _v31_6}}}else{switch(_p18._3._0.ctor){case"Red":if(_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Red"){break _v31_0}else{if(_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Red"){break _v31_1}else{break _v31_6}}case"NBlack":if(_p18._0.ctor==="BBlack"&&_p18._3._3.ctor==="RBNode_elm_builtin"&&_p18._3._3._0.ctor==="Black"&&_p18._3._4.ctor==="RBNode_elm_builtin"&&_p18._3._4._0.ctor==="Black"){break _v31_5}else{break _v31_6}default:break _v31_6}}}else{if(_p18._4.ctor==="RBNode_elm_builtin"){switch(_p18._4._0.ctor){case"Red":if(_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Red"){break _v31_2}else{if(_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Red"){break _v31_3}else{break _v31_6}}case"NBlack":if(_p18._0.ctor==="BBlack"&&_p18._4._3.ctor==="RBNode_elm_builtin"&&_p18._4._3._0.ctor==="Black"&&_p18._4._4.ctor==="RBNode_elm_builtin"&&_p18._4._4._0.ctor==="Black"){break _v31_4}else{break _v31_6}default:break _v31_6}}else{break _v31_6}}}else{break _v31_6}}while(false);return balancedTree(_p18._0)(_p18._3._3._1)(_p18._3._3._2)(_p18._3._1)(_p18._3._2)(_p18._1)(_p18._2)(_p18._3._3._3)(_p18._3._3._4)(_p18._3._4)(_p18._4)}while(false);return balancedTree(_p18._0)(_p18._3._1)(_p18._3._2)(_p18._3._4._1)(_p18._3._4._2)(_p18._1)(_p18._2)(_p18._3._3)(_p18._3._4._3)(_p18._3._4._4)(_p18._4);
}while(false);return balancedTree(_p18._0)(_p18._1)(_p18._2)(_p18._4._3._1)(_p18._4._3._2)(_p18._4._1)(_p18._4._2)(_p18._3)(_p18._4._3._3)(_p18._4._3._4)(_p18._4._4)}while(false);return balancedTree(_p18._0)(_p18._1)(_p18._2)(_p18._4._1)(_p18._4._2)(_p18._4._4._1)(_p18._4._4._2)(_p18._3)(_p18._4._3)(_p18._4._4._3)(_p18._4._4._4)}while(false);return A5(RBNode_elm_builtin,Black,_p18._4._3._1,_p18._4._3._2,A5(RBNode_elm_builtin,Black,_p18._1,_p18._2,_p18._3,_p18._4._3._3),A5(balance,Black,_p18._4._1,_p18._4._2,_p18._4._3._4,redden(_p18._4._4)))}while(false);return A5(RBNode_elm_builtin,Black,_p18._3._4._1,_p18._3._4._2,A5(balance,Black,_p18._3._1,_p18._3._2,redden(_p18._3._3),_p18._3._4._3),A5(RBNode_elm_builtin,Black,_p18._1,_p18._2,_p18._3._4._4,_p18._4))}while(false);return tree};var balance=F5(function(c,k,v,l,r){var tree=A5(RBNode_elm_builtin,c,k,v,l,r);return blackish(tree)?balanceHelp(tree):tree});var bubble=F5(function(c,k,v,l,r){return isBBlack(l)||isBBlack(r)?A5(balance,moreBlack(c),k,v,lessBlackTree(l),lessBlackTree(r)):A5(RBNode_elm_builtin,c,k,v,l,r)});var removeMax=F5(function(c,k,v,l,r){var _p19=r;if(_p19.ctor==="RBEmpty_elm_builtin"){return A3(rem,c,l,r)}else{return A5(bubble,c,k,v,l,A5(removeMax,_p19._0,_p19._1,_p19._2,_p19._3,_p19._4))}});var rem=F3(function(c,l,r){var _p20={ctor:"_Tuple2",_0:l,_1:r};if(_p20._0.ctor==="RBEmpty_elm_builtin"){if(_p20._1.ctor==="RBEmpty_elm_builtin"){var _p21=c;switch(_p21.ctor){case"Red":return RBEmpty_elm_builtin(LBlack);case"Black":return RBEmpty_elm_builtin(LBBlack);default:return $Native$Debug.crash("cannot have bblack or nblack nodes at this point")}}else{var _p24=_p20._1._0;var _p23=_p20._0._0;var _p22={ctor:"_Tuple3",_0:c,_1:_p23,_2:_p24};if(_p22.ctor==="_Tuple3"&&_p22._0.ctor==="Black"&&_p22._1.ctor==="LBlack"&&_p22._2.ctor==="Red"){return A5(RBNode_elm_builtin,Black,_p20._1._1,_p20._1._2,_p20._1._3,_p20._1._4)}else{return A4(reportRemBug,"Black/LBlack/Red",c,$Basics.toString(_p23),$Basics.toString(_p24))}}}else{if(_p20._1.ctor==="RBEmpty_elm_builtin"){var _p27=_p20._1._0;var _p26=_p20._0._0;var _p25={ctor:"_Tuple3",_0:c,_1:_p26,_2:_p27};if(_p25.ctor==="_Tuple3"&&_p25._0.ctor==="Black"&&_p25._1.ctor==="Red"&&_p25._2.ctor==="LBlack"){return A5(RBNode_elm_builtin,Black,_p20._0._1,_p20._0._2,_p20._0._3,_p20._0._4)}else{return A4(reportRemBug,"Black/Red/LBlack",c,$Basics.toString(_p26),$Basics.toString(_p27))}}else{var _p31=_p20._0._2;var _p30=_p20._0._4;var _p29=_p20._0._1;var l$=A5(removeMax,_p20._0._0,_p29,_p31,_p20._0._3,_p30);var _p28=A3(maxWithDefault,_p29,_p31,_p30);var k=_p28._0;var v=_p28._1;return A5(bubble,c,k,v,l$,r)}}});var update=F3(function(k,alter,dict){var up=function(dict){var _p32=dict;if(_p32.ctor==="RBEmpty_elm_builtin"){var _p33=alter($Maybe.Nothing);if(_p33.ctor==="Nothing"){return{ctor:"_Tuple2",_0:Same,_1:empty}}else{return{ctor:"_Tuple2",_0:Insert,_1:A5(RBNode_elm_builtin,Red,k,_p33._0,empty,empty)}}}else{var _p44=_p32._2;var _p43=_p32._4;var _p42=_p32._3;var _p41=_p32._1;var _p40=_p32._0;var _p34=A2($Basics.compare,k,_p41);switch(_p34.ctor){case"EQ":var _p35=alter($Maybe.Just(_p44));if(_p35.ctor==="Nothing"){return{ctor:"_Tuple2",_0:Remove,_1:A3(rem,_p40,_p42,_p43)}}else{return{ctor:"_Tuple2",_0:Same,_1:A5(RBNode_elm_builtin,_p40,_p41,_p35._0,_p42,_p43)}}case"LT":var _p36=up(_p42);var flag=_p36._0;var newLeft=_p36._1;var _p37=flag;switch(_p37.ctor){case"Same":return{ctor:"_Tuple2",_0:Same,_1:A5(RBNode_elm_builtin,_p40,_p41,_p44,newLeft,_p43)};case"Insert":return{ctor:"_Tuple2",_0:Insert,_1:A5(balance,_p40,_p41,_p44,newLeft,_p43)};default:return{ctor:"_Tuple2",_0:Remove,_1:A5(bubble,_p40,_p41,_p44,newLeft,_p43)}}default:var _p38=up(_p43);var flag=_p38._0;var newRight=_p38._1;var _p39=flag;switch(_p39.ctor){case"Same":return{ctor:"_Tuple2",_0:Same,_1:A5(RBNode_elm_builtin,_p40,_p41,_p44,_p42,newRight)};case"Insert":return{ctor:"_Tuple2",_0:Insert,_1:A5(balance,_p40,_p41,_p44,_p42,newRight)};default:return{ctor:"_Tuple2",_0:Remove,_1:A5(bubble,_p40,_p41,_p44,_p42,newRight)}}}}};var _p45=up(dict);var flag=_p45._0;var updatedDict=_p45._1;var _p46=flag;switch(_p46.ctor){case"Same":return updatedDict;case"Insert":return ensureBlackRoot(updatedDict);default:return blacken(updatedDict)}});var insert=F3(function(key,value,dict){return A3(update,key,$Basics.always($Maybe.Just(value)),dict)});var singleton=F2(function(key,value){return A3(insert,key,value,empty)});var union=F2(function(t1,t2){return A3(foldl,insert,t2,t1)});var fromList=function(assocs){return A3($List.foldl,F2(function(_p47,dict){var _p48=_p47;return A3(insert,_p48._0,_p48._1,dict)}),empty,assocs)};var filter=F2(function(predicate,dictionary){var add=F3(function(key,value,dict){return A2(predicate,key,value)?A3(insert,key,value,dict):dict});return A3(foldl,add,empty,dictionary)});var intersect=F2(function(t1,t2){return A2(filter,F2(function(k,_p49){return A2(member,k,t2)}),t1)});var partition=F2(function(predicate,dict){var add=F3(function(key,value,_p50){var _p51=_p50;var _p53=_p51._1;var _p52=_p51._0;return A2(predicate,key,value)?{ctor:"_Tuple2",_0:A3(insert,key,value,_p52),_1:_p53}:{ctor:"_Tuple2",_0:_p52,_1:A3(insert,key,value,_p53)}});return A3(foldl,add,{ctor:"_Tuple2",_0:empty,_1:empty},dict)});var remove=F2(function(key,dict){return A3(update,key,$Basics.always($Maybe.Nothing),dict)});var diff=F2(function(t1,t2){return A3(foldl,F3(function(k,v,t){return A2(remove,k,t)}),t1,t2)});return _elm.Dict.values={_op:_op,empty:empty,singleton:singleton,insert:insert,update:update,isEmpty:isEmpty,get:get,remove:remove,member:member,size:size,filter:filter,partition:partition,foldl:foldl,foldr:foldr,map:map,union:union,intersect:intersect,diff:diff,keys:keys,values:values,toList:toList,fromList:fromList}};Elm.Set=Elm.Set||{};Elm.Set.make=function(_elm){"use strict";_elm.Set=_elm.Set||{};if(_elm.Set.values)return _elm.Set.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Dict=Elm.Dict.make(_elm),$List=Elm.List.make(_elm);var _op={};var foldr=F3(function(f,b,_p0){var _p1=_p0;return A3($Dict.foldr,F3(function(k,_p2,b){return A2(f,k,b)}),b,_p1._0)});var foldl=F3(function(f,b,_p3){var _p4=_p3;return A3($Dict.foldl,F3(function(k,_p5,b){return A2(f,k,b)}),b,_p4._0)});var toList=function(_p6){var _p7=_p6;return $Dict.keys(_p7._0)};var size=function(_p8){var _p9=_p8;return $Dict.size(_p9._0)};var member=F2(function(k,_p10){var _p11=_p10;return A2($Dict.member,k,_p11._0)});var isEmpty=function(_p12){var _p13=_p12;return $Dict.isEmpty(_p13._0)};var Set_elm_builtin=function(a){return{ctor:"Set_elm_builtin",_0:a}};var empty=Set_elm_builtin($Dict.empty);var singleton=function(k){return Set_elm_builtin(A2($Dict.singleton,k,{ctor:"_Tuple0"}))};var insert=F2(function(k,_p14){var _p15=_p14;return Set_elm_builtin(A3($Dict.insert,k,{ctor:"_Tuple0"},_p15._0))});var fromList=function(xs){return A3($List.foldl,insert,empty,xs)};var map=F2(function(f,s){return fromList(A2($List.map,f,toList(s)))});var remove=F2(function(k,_p16){var _p17=_p16;return Set_elm_builtin(A2($Dict.remove,k,_p17._0))});var union=F2(function(_p19,_p18){var _p20=_p19;var _p21=_p18;return Set_elm_builtin(A2($Dict.union,_p20._0,_p21._0))});var intersect=F2(function(_p23,_p22){var _p24=_p23;var _p25=_p22;return Set_elm_builtin(A2($Dict.intersect,_p24._0,_p25._0))});var diff=F2(function(_p27,_p26){var _p28=_p27;var _p29=_p26;return Set_elm_builtin(A2($Dict.diff,_p28._0,_p29._0))});var filter=F2(function(p,_p30){var _p31=_p30;return Set_elm_builtin(A2($Dict.filter,F2(function(k,_p32){return p(k)}),_p31._0))});var partition=F2(function(p,_p33){var _p34=_p33;var _p35=A2($Dict.partition,F2(function(k,_p36){return p(k)}),_p34._0);var p1=_p35._0;var p2=_p35._1;return{ctor:"_Tuple2",_0:Set_elm_builtin(p1),_1:Set_elm_builtin(p2)}});return _elm.Set.values={_op:_op,empty:empty,singleton:singleton,insert:insert,remove:remove,isEmpty:isEmpty,member:member,size:size,foldl:foldl,foldr:foldr,map:map,filter:filter,partition:partition,union:union,intersect:intersect,diff:diff,toList:toList,fromList:fromList}};Elm.Native.Keyboard={};Elm.Native.Keyboard.make=function(localRuntime){localRuntime.Native=localRuntime.Native||{};localRuntime.Native.Keyboard=localRuntime.Native.Keyboard||{};if(localRuntime.Native.Keyboard.values){return localRuntime.Native.Keyboard.values}var NS=Elm.Native.Signal.make(localRuntime);function keyEvent(event){return{alt:event.altKey,meta:event.metaKey,keyCode:event.keyCode}}function keyStream(node,eventName,handler){var stream=NS.input(eventName,{alt:false,meta:false,keyCode:0});localRuntime.addListener([stream.id],node,eventName,function(e){localRuntime.notify(stream.id,handler(e))});return stream}var downs=keyStream(document,"keydown",keyEvent);var ups=keyStream(document,"keyup",keyEvent);var presses=keyStream(document,"keypress",keyEvent);var blurs=keyStream(window,"blur",function(){return null});return localRuntime.Native.Keyboard.values={downs:downs,ups:ups,blurs:blurs,presses:presses}};Elm.Keyboard=Elm.Keyboard||{};Elm.Keyboard.make=function(_elm){"use strict";_elm.Keyboard=_elm.Keyboard||{};if(_elm.Keyboard.values)return _elm.Keyboard.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Char=Elm.Char.make(_elm),$Native$Keyboard=Elm.Native.Keyboard.make(_elm),$Set=Elm.Set.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var presses=A2($Signal.map,function(_){return _.keyCode},$Native$Keyboard.presses);var toXY=F2(function(_p0,keyCodes){var _p1=_p0;var is=function(keyCode){return A2($Set.member,keyCode,keyCodes)?1:0};return{x:is(_p1.right)-is(_p1.left),y:is(_p1.up)-is(_p1.down)}});var Directions=F4(function(a,b,c,d){return{up:a,down:b,left:c,right:d}});var dropMap=F2(function(f,signal){return $Signal.dropRepeats(A2($Signal.map,f,signal))});var EventInfo=F3(function(a,b,c){return{alt:a,meta:b,keyCode:c}});var Blur={ctor:"Blur"};var Down=function(a){return{ctor:"Down",_0:a}};var Up=function(a){return{ctor:"Up",_0:a}};var rawEvents=$Signal.mergeMany(_U.list([A2($Signal.map,Up,$Native$Keyboard.ups),A2($Signal.map,Down,$Native$Keyboard.downs),A2($Signal.map,$Basics.always(Blur),$Native$Keyboard.blurs)]));var empty={alt:false,meta:false,keyCodes:$Set.empty};var update=F2(function(event,model){var _p2=event;switch(_p2.ctor){case"Down":var _p3=_p2._0;return{alt:_p3.alt,meta:_p3.meta,keyCodes:A2($Set.insert,_p3.keyCode,model.keyCodes)};case"Up":var _p4=_p2._0;return{alt:_p4.alt,meta:_p4.meta,keyCodes:A2($Set.remove,_p4.keyCode,model.keyCodes)};default:return empty}});var model=A3($Signal.foldp,update,empty,rawEvents);var alt=A2(dropMap,function(_){return _.alt},model);var meta=A2(dropMap,function(_){return _.meta},model);var keysDown=A2(dropMap,function(_){return _.keyCodes},model);var arrows=A2(dropMap,toXY({up:38,down:40,left:37,right:39}),keysDown);var wasd=A2(dropMap,toXY({up:87,down:83,left:65,right:68}),keysDown);var isDown=function(keyCode){return A2(dropMap,$Set.member(keyCode),keysDown)};var ctrl=isDown(17);var shift=isDown(16);var space=isDown(32);var enter=isDown(13);var Model=F3(function(a,b,c){return{alt:a,meta:b,keyCodes:c}});return _elm.Keyboard.values={_op:_op,arrows:arrows,wasd:wasd,enter:enter,space:space,ctrl:ctrl,shift:shift,alt:alt,meta:meta,isDown:isDown,keysDown:keysDown,presses:presses}};Elm.Native=Elm.Native||{};Elm.Native.Window={};Elm.Native.Window.make=function make(localRuntime){localRuntime.Native=localRuntime.Native||{};localRuntime.Native.Window=localRuntime.Native.Window||{};if(localRuntime.Native.Window.values){return localRuntime.Native.Window.values}var NS=Elm.Native.Signal.make(localRuntime);var Tuple2=Elm.Native.Utils.make(localRuntime).Tuple2;function getWidth(){return localRuntime.node.clientWidth}function getHeight(){if(localRuntime.isFullscreen()){return window.innerHeight}return localRuntime.node.clientHeight}var dimensions=NS.input("Window.dimensions",Tuple2(getWidth(),getHeight()));function resizeIfNeeded(){var w=getWidth();var h=getHeight();if(dimensions.value._0===w&&dimensions.value._1===h){return}setTimeout(function(){w=getWidth();h=getHeight();if(dimensions.value._0===w&&dimensions.value._1===h){return}localRuntime.notify(dimensions.id,Tuple2(w,h))},0)}localRuntime.addListener([dimensions.id],window,"resize",resizeIfNeeded);return localRuntime.Native.Window.values={dimensions:dimensions,resizeIfNeeded:resizeIfNeeded}};Elm.Random=Elm.Random||{};Elm.Random.make=function(_elm){"use strict";_elm.Random=_elm.Random||{};if(_elm.Random.values)return _elm.Random.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$List=Elm.List.make(_elm);var _op={};var magicNum8=2147483562;var range=function(_p0){return{ctor:"_Tuple2",_0:0,_1:magicNum8}};var magicNum7=2137383399;var magicNum6=2147483563;var magicNum5=3791;var magicNum4=40692;var magicNum3=52774;var magicNum2=12211;var magicNum1=53668;var magicNum0=40014;var generate=F2(function(_p1,seed){var _p2=_p1;return _p2._0(seed)});var Seed=function(a){return{ctor:"Seed",_0:a}};var State=F2(function(a,b){return{ctor:"State",_0:a,_1:b}});var initState=function(s$){var s=A2($Basics.max,s$,0-s$);var q=s/(magicNum6-1)|0;var s2=A2($Basics._op["%"],q,magicNum7-1);var s1=A2($Basics._op["%"],s,magicNum6-1);return A2(State,s1+1,s2+1)};var next=function(_p3){var _p4=_p3;var _p6=_p4._1;var _p5=_p4._0;var k$=_p6/magicNum3|0;var s2$=magicNum4*(_p6-k$*magicNum3)-k$*magicNum5;var s2$$=_U.cmp(s2$,0)<0?s2$+magicNum7:s2$;var k=_p5/magicNum1|0;var s1$=magicNum0*(_p5-k*magicNum1)-k*magicNum2;var s1$$=_U.cmp(s1$,0)<0?s1$+magicNum6:s1$;var z=s1$$-s2$$;var z$=_U.cmp(z,1)<0?z+magicNum8:z;return{ctor:"_Tuple2",_0:z$,_1:A2(State,s1$$,s2$$)}};var split=function(_p7){var _p8=_p7;var _p11=_p8._1;var _p10=_p8._0;var _p9=$Basics.snd(next(_p8));var t1=_p9._0;var t2=_p9._1;var new_s2=_U.eq(_p11,1)?magicNum7-1:_p11-1;var new_s1=_U.eq(_p10,magicNum6-1)?1:_p10+1;return{ctor:"_Tuple2",_0:A2(State,new_s1,t2),_1:A2(State,t1,new_s2)}};var initialSeed=function(n){return Seed({state:initState(n),next:next,split:split,range:range})};var Generator=function(a){return{ctor:"Generator",_0:a}};var andThen=F2(function(_p12,callback){var _p13=_p12;return Generator(function(seed){var _p14=_p13._0(seed);var result=_p14._0;var newSeed=_p14._1;var _p15=callback(result);var genB=_p15._0;return genB(newSeed)})});var map5=F6(function(func,_p20,_p19,_p18,_p17,_p16){var _p21=_p20;var _p22=_p19;var _p23=_p18;var _p24=_p17;var _p25=_p16;return Generator(function(seed0){var _p26=_p21._0(seed0);var a=_p26._0;var seed1=_p26._1;var _p27=_p22._0(seed1);var b=_p27._0;var seed2=_p27._1;var _p28=_p23._0(seed2);var c=_p28._0;var seed3=_p28._1;var _p29=_p24._0(seed3);var d=_p29._0;var seed4=_p29._1;var _p30=_p25._0(seed4);var e=_p30._0;var seed5=_p30._1;return{ctor:"_Tuple2",_0:A5(func,a,b,c,d,e),_1:seed5}})});var map4=F5(function(func,_p34,_p33,_p32,_p31){var _p35=_p34;var _p36=_p33;var _p37=_p32;var _p38=_p31;return Generator(function(seed0){var _p39=_p35._0(seed0);var a=_p39._0;var seed1=_p39._1;var _p40=_p36._0(seed1);var b=_p40._0;var seed2=_p40._1;var _p41=_p37._0(seed2);var c=_p41._0;var seed3=_p41._1;var _p42=_p38._0(seed3);var d=_p42._0;var seed4=_p42._1;return{ctor:"_Tuple2",_0:A4(func,a,b,c,d),_1:seed4}})});var map3=F4(function(func,_p45,_p44,_p43){var _p46=_p45;var _p47=_p44;var _p48=_p43;return Generator(function(seed0){var _p49=_p46._0(seed0);var a=_p49._0;var seed1=_p49._1;var _p50=_p47._0(seed1);var b=_p50._0;var seed2=_p50._1;var _p51=_p48._0(seed2);var c=_p51._0;var seed3=_p51._1;return{ctor:"_Tuple2",_0:A3(func,a,b,c),_1:seed3}})});var map2=F3(function(func,_p53,_p52){var _p54=_p53;var _p55=_p52;return Generator(function(seed0){var _p56=_p54._0(seed0);var a=_p56._0;var seed1=_p56._1;var _p57=_p55._0(seed1);var b=_p57._0;var seed2=_p57._1;return{ctor:"_Tuple2",_0:A2(func,a,b),_1:seed2}})});var map=F2(function(func,_p58){var _p59=_p58;return Generator(function(seed0){var _p60=_p59._0(seed0);var a=_p60._0;var seed1=_p60._1;return{ctor:"_Tuple2",_0:func(a),_1:seed1}})});var listHelp=F4(function(list,n,generate,seed){listHelp:while(true)if(_U.cmp(n,1)<0)return{ctor:"_Tuple2",_0:$List.reverse(list),_1:seed};else{var _p61=generate(seed);var value=_p61._0;var newSeed=_p61._1;var _v19=A2($List._op["::"],value,list),_v20=n-1,_v21=generate,_v22=newSeed;list=_v19;n=_v20;generate=_v21;seed=_v22;continue listHelp}});var list=F2(function(n,_p62){var _p63=_p62;return Generator(function(seed){return A4(listHelp,_U.list([]),n,_p63._0,seed)})});var pair=F2(function(genA,genB){return A3(map2,F2(function(v0,v1){return{ctor:"_Tuple2",_0:v0,_1:v1}}),genA,genB)});var minInt=-2147483648;var maxInt=2147483647;var iLogBase=F2(function(b,i){return _U.cmp(i,b)<0?1:1+A2(iLogBase,b,i/b|0)});var $int=F2(function(a,b){return Generator(function(_p64){var _p65=_p64;var _p70=_p65._0;var base=2147483561;var f=F3(function(n,acc,state){f:while(true){var _p66=n;if(_p66===0){return{ctor:"_Tuple2",_0:acc,_1:state}}else{var _p67=_p70.next(state);var x=_p67._0;var state$=_p67._1;var _v26=n-1,_v27=x+acc*base,_v28=state$;n=_v26;acc=_v27;state=_v28;continue f}}});var _p68=_U.cmp(a,b)<0?{ctor:"_Tuple2",_0:a,_1:b}:{ctor:"_Tuple2",_0:b,_1:a};var lo=_p68._0;var hi=_p68._1;var k=hi-lo+1;var n=A2(iLogBase,base,k);var _p69=A3(f,n,1,_p70.state);var v=_p69._0;var state$=_p69._1;return{ctor:"_Tuple2",_0:lo+A2($Basics._op["%"],v,k),_1:Seed(_U.update(_p70,{state:state$}))}})});var $float=F2(function(a,b){return Generator(function(seed){var _p71=A2(generate,A2($int,minInt,maxInt),seed);var number=_p71._0;var newSeed=_p71._1;var negativeOneToOne=$Basics.toFloat(number)/$Basics.toFloat(maxInt-minInt);var _p72=_U.cmp(a,b)<0?{ctor:"_Tuple2",_0:a,_1:b}:{ctor:"_Tuple2",_0:b,_1:a};var lo=_p72._0;var hi=_p72._1;var scaled=(lo+hi)/2+(hi-lo)*negativeOneToOne;return{ctor:"_Tuple2",_0:scaled,_1:newSeed}})});var bool=A2(map,F2(function(x,y){return _U.eq(x,y)})(1),A2($int,0,1));return _elm.Random.values={_op:_op,bool:bool,$int:$int,$float:$float,list:list,pair:pair,map:map,map2:map2,map3:map3,map4:map4,map5:map5,andThen:andThen,minInt:minInt,maxInt:maxInt,generate:generate,initialSeed:initialSeed}};Elm.Window=Elm.Window||{};Elm.Window.make=function(_elm){"use strict";_elm.Window=_elm.Window||{};if(_elm.Window.values)return _elm.Window.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Native$Window=Elm.Native.Window.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var dimensions=$Native$Window.dimensions;var width=A2($Signal.map,$Basics.fst,dimensions);var height=A2($Signal.map,$Basics.snd,dimensions);return _elm.Window.values={_op:_op,dimensions:dimensions,width:width,height:height}};Elm.Constants=Elm.Constants||{};Elm.Constants.make=function(_elm){"use strict";_elm.Constants=_elm.Constants||{};if(_elm.Constants.values)return _elm.Constants.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var maxDifficultyScore=4e4;var initialBigSaucerCount=3;var saucerTicksMax=1e3;var saucerTicksMin=300;var saucerShotAccuracyRange={ctor:"_Tuple2",_0:.75,_1:.999};var saucerScoreSmall=1e3;var saucerScoreBig=200;var saucerShotTicks=40;var saucerDirectionTicksMax=200;var saucerDirectionTicksMin=50;var saucerSpeedY=.0015;var saucerSpeedX=.002;var saucerSizeCollisionRatio=.4;var explosionSize=.021;var debrisSize=explosionSize/10;var explosionSpeed=.001;var explosionLifetime=30;var asteroidScoreSmall=100;var asteroidScoreMedium=50;var asteroidScoreBig=20;var asteroidSizeSmall=.01;var asteroidSizeMedium=.02;var asteroidSizeBig=.04;var asteroidSpeedSmall=.003;var asteroidSpeedMedium=.002;var asteroidSpeedBig=.001;var asteroidSpeedMin=5e-4;var shotLifetime=40;var shotSpeed={x:0,y:.012};var deadShipMomentumChange=.4;var deadShipTicks=120;var hyperspaceTicks=30;var nextLevelDelayTicks=120;var invincibleShipTicks=100;var maxMomentum=.009;var spaceFriction=.992;var thrust={x:0,y:9e-5};var turningSpeed=.075;var lifeSize=.021;var shipDebrisSize=.02;var shipSize=.03;var shipSizeForCollisions=shipSize*.4;var gameTextHeight=shipSize;var scoreTextHeight=shipSize;var shotSize=shipSize*.2;var saucerSizeBig=shipSize*1.5;var saucerSizeSmall=saucerSizeBig/2;var introAsteroidCount=30;var startAsteroidCount=8;var extraLifeMultiple=1e4;var startLives=3;var tickFps=60;var gameHeight=3/4;var gameBoundsMinY=(0-gameHeight)/2;var gameBoundsMaxY=gameHeight/2;var gameWidth=1;var gameBoundsMinX=(0-gameWidth)/2;var gameBoundsMin={x:gameBoundsMinX,y:gameBoundsMinY};var gameBoundsMaxX=gameWidth/2;var gameBoundsMax={x:gameBoundsMaxX,y:gameBoundsMaxY};var gameBounds={ctor:"_Tuple2",_0:gameBoundsMin,_1:gameBoundsMax};return _elm.Constants.values={_op:_op,gameWidth:gameWidth,gameHeight:gameHeight,gameBoundsMinX:gameBoundsMinX,gameBoundsMaxX:gameBoundsMaxX,gameBoundsMinY:gameBoundsMinY,gameBoundsMaxY:gameBoundsMaxY,gameBoundsMin:gameBoundsMin,gameBoundsMax:gameBoundsMax,gameBounds:gameBounds,tickFps:tickFps,startLives:startLives,extraLifeMultiple:extraLifeMultiple,startAsteroidCount:startAsteroidCount,introAsteroidCount:introAsteroidCount,shipSize:shipSize,shipSizeForCollisions:shipSizeForCollisions,shipDebrisSize:shipDebrisSize,lifeSize:lifeSize,gameTextHeight:gameTextHeight,scoreTextHeight:scoreTextHeight,turningSpeed:turningSpeed,thrust:thrust,spaceFriction:spaceFriction,maxMomentum:maxMomentum,invincibleShipTicks:invincibleShipTicks,nextLevelDelayTicks:nextLevelDelayTicks,hyperspaceTicks:hyperspaceTicks,deadShipTicks:deadShipTicks,deadShipMomentumChange:deadShipMomentumChange,shotSize:shotSize,shotSpeed:shotSpeed,shotLifetime:shotLifetime,asteroidSpeedMin:asteroidSpeedMin,asteroidSpeedBig:asteroidSpeedBig,asteroidSpeedMedium:asteroidSpeedMedium,asteroidSpeedSmall:asteroidSpeedSmall,asteroidSizeBig:asteroidSizeBig,asteroidSizeMedium:asteroidSizeMedium,asteroidSizeSmall:asteroidSizeSmall,asteroidScoreBig:asteroidScoreBig,asteroidScoreMedium:asteroidScoreMedium,asteroidScoreSmall:asteroidScoreSmall,explosionLifetime:explosionLifetime,explosionSpeed:explosionSpeed,explosionSize:explosionSize,debrisSize:debrisSize,saucerSizeBig:saucerSizeBig,saucerSizeSmall:saucerSizeSmall,saucerSizeCollisionRatio:saucerSizeCollisionRatio,saucerSpeedX:saucerSpeedX,saucerSpeedY:saucerSpeedY,saucerDirectionTicksMin:saucerDirectionTicksMin,saucerDirectionTicksMax:saucerDirectionTicksMax,saucerShotTicks:saucerShotTicks,saucerScoreBig:saucerScoreBig,saucerScoreSmall:saucerScoreSmall,saucerShotAccuracyRange:saucerShotAccuracyRange,saucerTicksMin:saucerTicksMin,saucerTicksMax:saucerTicksMax,initialBigSaucerCount:initialBigSaucerCount,maxDifficultyScore:maxDifficultyScore}};Elm.Vec2=Elm.Vec2||{};Elm.Vec2.make=function(_elm){"use strict";_elm.Vec2=_elm.Vec2||{};if(_elm.Vec2.values)return _elm.Vec2.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var angleBetween=F2(function(a,b){var yDiff=b.y-a.y;var xDiff=b.x-a.x;return A2($Basics.atan2,xDiff,yDiff)});var asTuple=function(point){return{ctor:"_Tuple2",_0:point.x,_1:point.y}};var wrapFloat=F3(function(input,min,max){var size=max-min;return _U.cmp(input,min)<0?input+size:_U.cmp(input,max)>-1?input-size:input});var wrapVec2=F2(function(_p0,input){var _p1=_p0;var _p3=_p1._0;var _p2=_p1._1;return{x:A3(wrapFloat,input.x,_p3.x,_p2.x),y:A3(wrapFloat,input.y,_p3.y,_p2.y)}});var randomVec2Y=F3(function(x,min,max){return A2($Random.map,function(y){return{x:x,y:y}},A2($Random.$float,min,max))});var randomVec2X=F3(function(y,min,max){return A2($Random.map,function(x){return{x:x,y:y}},A2($Random.$float,min,max))});var randomVec2InBounds=function(_p4){var _p5=_p4;var _p7=_p5._0;var _p6=_p5._1;return A3($Random.map2,F2(function(x,y){return{x:x,y:y}}),A2($Random.$float,_p7.x,_p6.x),A2($Random.$float,_p7.y,_p6.y))};var randomVec2=F2(function(min,max){return A3($Random.map2,F2(function(x,y){return{x:x,y:y}}),A2($Random.$float,min,max),A2($Random.$float,min,max))});var length=function(v){return $Basics.sqrt(v.x*v.x+v.y*v.y)};var rotate=F2(function(a,v){var sina=$Basics.sin(a);var cosa=$Basics.cos(a);return{x:v.x*cosa-v.y*sina,y:v.x*sina+v.y*cosa}});var subtract=F2(function(v1,v2){return{x:v1.x-v2.x,y:v1.y-v2.y}});var distance=F2(function(v1,v2){return length(A2(subtract,v1,v2))});var circlesOverlap=F2(function(_p9,_p8){var _p10=_p9;var _p11=_p8;return _U.cmp(A2(distance,_p10._0,_p11._0),_p10._1+_p11._1)<1});var add=F2(function(v1,v2){return{x:v1.x+v2.x,y:v1.y+v2.y}});var scale=F2(function(a,v){return{x:v.x*a,y:v.y*a}});var origin={x:0,y:0};var Vec2=F2(function(a,b){return{x:a,y:b}});return _elm.Vec2.values={_op:_op,Vec2:Vec2,origin:origin,scale:scale,add:add,subtract:subtract,rotate:rotate,length:length,distance:distance,randomVec2:randomVec2,randomVec2InBounds:randomVec2InBounds,randomVec2X:randomVec2X,randomVec2Y:randomVec2Y,wrapVec2:wrapVec2,wrapFloat:wrapFloat,asTuple:asTuple,circlesOverlap:circlesOverlap,angleBetween:angleBetween}};Elm.RandomHelpers=Elm.RandomHelpers||{};Elm.RandomHelpers.make=function(_elm){"use strict";_elm.RandomHelpers=_elm.RandomHelpers||{};if(_elm.RandomHelpers.values)return _elm.RandomHelpers.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var randomFloat=F3(function(min,max,seed){return A2($Random.generate,A2($Random.$float,min,max),seed)});var randomAngle=function(seed){return A3(randomFloat,0,2*$Basics.pi,seed)};var randomInt=F3(function(min,max,seed){return A2($Random.generate,A2($Random.$int,min,max),seed)});return _elm.RandomHelpers.values={_op:_op,randomFloat:randomFloat,randomInt:randomInt,randomAngle:randomAngle}};Elm.Asteroid=Elm.Asteroid||{};Elm.Asteroid.make=function(_elm){"use strict";_elm.Asteroid=_elm.Asteroid||{};if(_elm.Asteroid.values)return _elm.Asteroid.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var asteroidScore=function(asteroid){var _p0=asteroid.sizeClass;switch(_p0.ctor){case"Big":return $Constants.asteroidScoreBig;case"Medium":return $Constants.asteroidScoreMedium;default:return $Constants.asteroidScoreSmall}};var asteroidSize=function(size){var _p1=size;switch(_p1.ctor){case"Big":return $Constants.asteroidSizeBig;case"Medium":return $Constants.asteroidSizeMedium;default:return $Constants.asteroidSizeSmall}};var splitAsteroids=F2(function(asteroids,seed){return{ctor:"_Tuple2",_0:asteroids,_1:seed}});var tickAsteroid=function(asteroid){return _U.update(asteroid,{position:A2($Vec2.wrapVec2,$Constants.gameBounds,A2($Vec2.add,asteroid.position,asteroid.momentum))})};var positionOnSideGenerator=function(){var _p2=$Constants.gameBounds;var boundsMin=_p2._0;var boundsMax=_p2._1;return A2($Random.andThen,A2($Random.$int,0,4),function(side){var _p3=side;switch(_p3){case 0:return A3($Vec2.randomVec2Y,boundsMin.x,boundsMin.y,boundsMax.y);case 1:return A3($Vec2.randomVec2X,boundsMin.y,boundsMin.x,boundsMax.x);case 2:return A3($Vec2.randomVec2Y,boundsMax.x,boundsMin.y,boundsMax.y);default:return A3($Vec2.randomVec2X,boundsMax.y,boundsMin.x,boundsMax.x)}})}();var applyMomentum=F2(function(asteroid,momentum){var mag=$Vec2.length(momentum);var momentum$=_U.cmp(mag,$Constants.asteroidSpeedMin)<0?A2($Vec2.scale,$Constants.asteroidSpeedMin/mag,momentum):momentum;return _U.update(asteroid,{momentum:momentum$})});var randomMomentumGenerator=function(asteroid){var momentumGenerator=function(){var _p4=asteroid.sizeClass;switch(_p4.ctor){case"Big":return A2($Vec2.randomVec2,0-$Constants.asteroidSpeedBig,$Constants.asteroidSpeedBig);case"Medium":return A2($Vec2.randomVec2,0-$Constants.asteroidSpeedMedium,$Constants.asteroidSpeedMedium);default:return A2($Vec2.randomVec2,0-$Constants.asteroidSpeedSmall,$Constants.asteroidSpeedSmall)}}();return A2($Random.map,applyMomentum(asteroid),momentumGenerator)};var Asteroid=F7(function(a,b,c,d,e,f,g){return{sizeClass:a,kind:b,status:c,position:d,momentum:e,size:f,angle:g}});var Destroyed={ctor:"Destroyed"};var Active={ctor:"Active"};var C={ctor:"C"};var B={ctor:"B"};var A={ctor:"A"};var kindGenerator=A2($Random.map,function(kind){var _p5=kind;switch(_p5){case 0:return A;case 1:return B;default:return C}},A2($Random.$int,0,3));var asteroidPropertiesRandomizer=function(asteroid){return A2($Random.andThen,A3($Random.map2,F2(function(kind,angle){return _U.update(asteroid,{kind:kind,angle:angle})}),kindGenerator,A2($Random.$float,0,2*$Basics.pi)),randomMomentumGenerator)};var splitAsteroid=F3(function(asteroid,size,seed){var generator=asteroidPropertiesRandomizer(_U.update(asteroid,{sizeClass:size,size:asteroidSize(size),status:Active}));var _p6=A2($Random.generate,A2($Random.pair,generator,generator),seed);var a=_p6._0._0;var b=_p6._0._1;var seed$=_p6._1;return{ctor:"_Tuple3",_0:tickAsteroid(a),_1:tickAsteroid(b),_2:seed$}});var Small={ctor:"Small"};var Medium={ctor:"Medium"};var destroyAsteroid=F2(function(asteroid,seed){var _p7=asteroid.sizeClass;switch(_p7.ctor){case"Big":return $Maybe.Just(A3(splitAsteroid,asteroid,Medium,seed));case"Medium":return $Maybe.Just(A3(splitAsteroid,asteroid,Small,seed));default:return $Maybe.Nothing}});var Big={ctor:"Big"};var defaultAsteroid={sizeClass:Big,size:asteroidSize(Big),kind:A,status:Active,position:$Vec2.origin,momentum:$Vec2.origin,angle:0};var newAsteroid=A2($Random.andThen,A2($Random.map,function(position){return _U.update(defaultAsteroid,{position:position})},positionOnSideGenerator),asteroidPropertiesRandomizer);var sizeGenerator=A2($Random.map,function(kind){var _p8=kind;switch(_p8){case 0:return Big;case 1:return Medium;default:return Small}},A2($Random.$int,0,3));var introAsteroid=A2($Random.andThen,A3($Random.map2,F2(function(size,position){return _U.update(defaultAsteroid,{sizeClass:size,size:asteroidSize(size),position:position})}),sizeGenerator,$Vec2.randomVec2InBounds($Constants.gameBounds)),asteroidPropertiesRandomizer);return _elm.Asteroid.values={_op:_op,newAsteroid:newAsteroid,introAsteroid:introAsteroid,tickAsteroid:tickAsteroid,destroyAsteroid:destroyAsteroid,asteroidSize:asteroidSize,asteroidScore:asteroidScore,Asteroid:Asteroid,Big:Big,Medium:Medium,Small:Small,A:A,B:B,C:C,Active:Active,Destroyed:Destroyed}};Elm.Explosion=Elm.Explosion||{};Elm.Explosion.make=function(_elm){"use strict";_elm.Explosion=_elm.Explosion||{};if(_elm.Explosion.values)return _elm.Explosion.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$RandomHelpers=Elm.RandomHelpers.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var tickExplosion=function(explosion){var tickCount=explosion.tickCount+1;return _U.cmp(tickCount,$Constants.explosionLifetime)<0?$Maybe.Just(_U.update(explosion,{tickCount:tickCount})):$Maybe.Nothing};var newExplosion=F2(function(position,seed){var _p0=A3($RandomHelpers.randomFloat,0,2*$Basics.pi,seed);var angle=_p0._0;var seed$=_p0._1;return{ctor:"_Tuple2",_0:{position:position,angle:angle,tickCount:0},_1:seed$}});var Explosion=F3(function(a,b,c){return{position:a,angle:b,tickCount:c}});return _elm.Explosion.values={_op:_op,Explosion:Explosion,newExplosion:newExplosion,tickExplosion:tickExplosion}};Elm.GameObject=Elm.GameObject||{};Elm.GameObject.make=function(_elm){"use strict";_elm.GameObject=_elm.GameObject||{};if(_elm.GameObject.values)return _elm.GameObject.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);
var _op={};var collisionTest=F2(function(a,b){return A2($Vec2.circlesOverlap,{ctor:"_Tuple2",_0:a.position,_1:a.size},{ctor:"_Tuple2",_0:b.position,_1:b.size})});return _elm.GameObject.values={_op:_op,collisionTest:collisionTest}};Elm.KeyboardHelpers=Elm.KeyboardHelpers||{};Elm.KeyboardHelpers.make=function(_elm){"use strict";_elm.KeyboardHelpers=_elm.KeyboardHelpers||{};if(_elm.KeyboardHelpers.values)return _elm.KeyboardHelpers.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var defaultArrows={x:0,y:0};var Arrows=F2(function(a,b){return{x:a,y:b}});return _elm.KeyboardHelpers.values={_op:_op,defaultArrows:defaultArrows,Arrows:Arrows}};Elm.Shot=Elm.Shot||{};Elm.Shot.make=function(_elm){"use strict";_elm.Shot=_elm.Shot||{};if(_elm.Shot.values)return _elm.Shot.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var tickShot=function(shot){var tickCount$=shot.tickCount+1;return _U.cmp(tickCount$,$Constants.shotLifetime)<0?$Maybe.Just(_U.update(shot,{position:A2($Vec2.wrapVec2,$Constants.gameBounds,A2($Vec2.add,shot.position,shot.momentum)),tickCount:tickCount$})):$Maybe.Nothing};var newShot=F2(function(position,angle){return{position:position,momentum:A2($Vec2.rotate,angle,$Constants.shotSpeed),size:$Constants.shotSize,tickCount:0}});var Shot=F4(function(a,b,c,d){return{position:a,momentum:b,size:c,tickCount:d}});return _elm.Shot.values={_op:_op,Shot:Shot,newShot:newShot,tickShot:tickShot}};Elm.Ship=Elm.Ship||{};Elm.Ship.make=function(_elm){"use strict";_elm.Ship=_elm.Ship||{};if(_elm.Ship.values)return _elm.Ship.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$KeyboardHelpers=Elm.KeyboardHelpers.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$Result=Elm.Result.make(_elm),$Shot=Elm.Shot.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var fireShot=function(maybeShip){var _p0=maybeShip;if(_p0.ctor==="Nothing"){return $Maybe.Nothing}else{var _p2=_p0._0;var _p1=_p2.status;switch(_p1.ctor){case"Dead":return $Maybe.Nothing;case"Hyperspace":return $Maybe.Nothing;default:var shotOffset=_p2.size+$Constants.shotSize;var shotPosition=A2($Vec2.add,_p2.position,A2($Vec2.rotate,_p2.angle,{x:0,y:shotOffset}));return $Maybe.Just(A2($Shot.newShot,shotPosition,_p2.angle))}}};var applyThrust=F2(function(momentum,angle){var momentum$=A2($Vec2.add,momentum,A2($Vec2.rotate,angle,$Constants.thrust));var momentumMagnitude=$Vec2.length(momentum$);return _U.cmp(momentumMagnitude,$Constants.maxMomentum)>0?A2($Vec2.scale,$Constants.maxMomentum/momentumMagnitude,momentum$):momentum$});var applyMomentum=F2(function(position,momentum){return A2($Vec2.wrapVec2,$Constants.gameBounds,A2($Vec2.add,position,momentum))});var moveLiveShip=F2(function(ship,arrows){var thrust=_U.cmp(arrows.y,0)>0;var angle=_U.cmp(arrows.x,0)>0?ship.angle-$Constants.turningSpeed:_U.cmp(arrows.x,0)<0?ship.angle+$Constants.turningSpeed:ship.angle;var momentum=thrust?A2(applyThrust,ship.momentum,angle):A2($Vec2.scale,$Constants.spaceFriction,ship.momentum);var position=A2(applyMomentum,ship.position,momentum);return _U.update(ship,{position:position,momentum:momentum,angle:angle,thrust:thrust})});var moveDeadShip=function(ship){return _U.update(ship,{position:A2(applyMomentum,ship.position,ship.momentum)})};var moveShip=F2(function(maybeShip,arrows){var _p3=maybeShip;if(_p3.ctor==="Nothing"){return $Maybe.Nothing}else{var _p5=_p3._0;var ship$=function(){var _p4=_p5.status;if(_p4.ctor==="Dead"){return moveDeadShip(_p5)}else{return A2(moveLiveShip,_p5,arrows)}}();return $Maybe.Just(ship$)}});var Ship=F7(function(a,b,c,d,e,f,g){return{status:a,tickCount:b,angle:c,thrust:d,position:e,momentum:f,size:g}});var Dead={ctor:"Dead"};var defaultShip={status:Dead,tickCount:0,position:$Vec2.origin,momentum:$Vec2.origin,size:$Constants.shipSizeForCollisions,angle:0,thrust:false};var killShip=function(ship){return _U.update(ship,{status:Dead,tickCount:0,thrust:false,momentum:A2($Vec2.scale,$Constants.deadShipMomentumChange,ship.momentum)})};var Hyperspace={ctor:"Hyperspace"};var goIntoHyperspace=F2(function(maybeShip,seed){var _p6=maybeShip;if(_p6.ctor==="Nothing"){return{ctor:"_Tuple2",_0:$Maybe.Nothing,_1:seed}}else{var _p9=_p6._0;var _p7=_p9.status;if(_p7.ctor==="Alive"){var _p8=A2($Random.generate,$Vec2.randomVec2InBounds($Constants.gameBounds),seed);var position=_p8._0;var seed$=_p8._1;var ship$=_U.update(_p9,{status:Hyperspace,position:position,momentum:$Vec2.origin,tickCount:0});return{ctor:"_Tuple2",_0:$Maybe.Just(ship$),_1:seed$}}else{return{ctor:"_Tuple2",_0:$Maybe.Just(_p9),_1:seed}}}});var Invincible={ctor:"Invincible"};var invincibleShip=_U.update(defaultShip,{status:Invincible});var Alive={ctor:"Alive"};var newShip=_U.update(defaultShip,{status:Alive});var tickShipState=function(maybeShip){var _p10=maybeShip;if(_p10.ctor==="Nothing"){return $Maybe.Nothing}else{var _p12=_p10._0;var tickCount=_p12.tickCount+1;var ship$=_U.update(_p12,{tickCount:tickCount});var _p11=_p12.status;switch(_p11.ctor){case"Dead":return _U.cmp(tickCount,$Constants.deadShipTicks)<0?$Maybe.Just(ship$):$Maybe.Nothing;case"Invincible":return _U.cmp(tickCount,$Constants.invincibleShipTicks)<0?$Maybe.Just(ship$):$Maybe.Just(_U.update(ship$,{status:Alive}));case"Hyperspace":return _U.cmp(tickCount,$Constants.hyperspaceTicks)<0?$Maybe.Just(ship$):$Maybe.Just(_U.update(ship$,{status:Alive}));default:return $Maybe.Just(ship$)}}};return _elm.Ship.values={_op:_op,defaultShip:defaultShip,newShip:newShip,invincibleShip:invincibleShip,moveShip:moveShip,killShip:killShip,tickShipState:tickShipState,goIntoHyperspace:goIntoHyperspace,fireShot:fireShot,Ship:Ship,Alive:Alive,Invincible:Invincible,Hyperspace:Hyperspace,Dead:Dead}};Elm.Saucer=Elm.Saucer||{};Elm.Saucer.make=function(_elm){"use strict";_elm.Saucer=_elm.Saucer||{};if(_elm.Saucer.values)return _elm.Saucer.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$RandomHelpers=Elm.RandomHelpers.make(_elm),$Result=Elm.Result.make(_elm),$Ship=Elm.Ship.make(_elm),$Shot=Elm.Shot.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var saucerSizeForView=function(saucer){return saucer.size/$Constants.saucerSizeCollisionRatio};var saucerScore=function(saucer){var _p0=saucer.saucerType;if(_p0.ctor==="Big"){return $Constants.saucerScoreBig}else{return $Constants.saucerScoreSmall}};var shotAngle=F3(function(saucer,maybeShip,seed){var _p1=maybeShip;if(_p1.ctor==="Just"){var _p4=_p1._0;var _p2=_p4.status;switch(_p2.ctor){case"Dead":return $RandomHelpers.randomAngle(seed);case"Hyperspace":return $RandomHelpers.randomAngle(seed);default:var spread=$Basics.pi*(1-saucer.shotAccuracy);var _p3=A3($RandomHelpers.randomFloat,0-spread,spread,seed);var jitter=_p3._0;var seed$=_p3._1;var angle=$Basics.pi-A2($Vec2.angleBetween,_p4.position,saucer.position);return{ctor:"_Tuple2",_0:angle+jitter,_1:seed$}}}else{return $RandomHelpers.randomAngle(seed)}});var maybeFireShot=F3(function(saucer,ship,seed){if(_U.eq(A2($Basics._op["%"],saucer.tickCount,$Constants.saucerShotTicks),0)){var shotOffset=saucer.size+$Constants.shotSize;var _p5=A3(shotAngle,saucer,ship,seed);var angle=_p5._0;var seed$=_p5._1;var shotPosition=A2($Vec2.add,saucer.position,A2($Vec2.rotate,angle,{x:0,y:shotOffset}));return{ctor:"_Tuple2",_0:$Maybe.Just(A2($Shot.newShot,shotPosition,angle)),_1:seed$}}else return{ctor:"_Tuple2",_0:$Maybe.Nothing,_1:seed}});var moveSaucer=function(maybeSaucer){var _p6=maybeSaucer;if(_p6.ctor==="Nothing"){return $Maybe.Nothing}else{var _p7=_p6._0;var position=A2($Vec2.add,_p7.position,_p7.momentum);var wrappedY=_U.cmp(position.y,$Constants.gameBoundsMaxY)>0?$Constants.gameBoundsMinY:_U.cmp(position.y,$Constants.gameBoundsMinY)<0?$Constants.gameBoundsMaxY:position.y;var positionWrapped=_U.update(position,{y:wrappedY});return $Maybe.Just(_U.update(_p7,{position:positionWrapped}))}};var scheduleDirectionChange=function(_p8){var _p9=_p8;var _p11=_p9._0;var _p10=A3($RandomHelpers.randomInt,$Constants.saucerDirectionTicksMin,$Constants.saucerDirectionTicksMax,_p9._1);var change=_p10._0;var seed$=_p10._1;return{ctor:"_Tuple2",_0:_U.update(_p11,{tickNextDirectionChange:_p11.tickCount+change}),_1:seed$}};var changeDirection=F2(function(seed,saucer){if(_U.eq(saucer.tickCount,saucer.tickNextDirectionChange)){var _p12=A3($RandomHelpers.randomInt,0,2,seed);var dir=_p12._0;var seed$=_p12._1;var newY=(_U.cmp(saucer.momentum.y,0)>0?_U.eq(dir,0)?-1:0:_U.cmp(saucer.momentum.y,0)<0?_U.eq(dir,0)?1:0:_U.eq(dir,0)?1:-1)*$Constants.saucerSpeedY;var saucer$=_U.update(saucer,{momentum:{x:saucer.momentum.x,y:newY}});return scheduleDirectionChange({ctor:"_Tuple2",_0:saucer$,_1:seed$})}else return{ctor:"_Tuple2",_0:saucer,_1:seed}});var tickSaucer=F2(function(saucer,seed){return A2(changeDirection,seed,_U.update(saucer,{tickCount:saucer.tickCount+1}))});var interpolate=F2(function(_p13,x){var _p14=_p13;var _p15=_p14._0;return _p15+(_p14._1-_p15)*x});var posAndSpeedYGenerator=A3($Random.map2,F2(function(dirY,posY){return{ctor:"_Tuple2",_0:posY,_1:function(){var _p16=dirY;switch(_p16){case 0:return 0-$Constants.saucerSpeedY;case 1:return 0;default:return $Constants.saucerSpeedY}}()}}),A2($Random.$int,0,3),A2($Random.$float,$Constants.gameBoundsMinY,$Constants.gameBoundsMaxY));var posAndSpeedXGenerator=A2($Random.map,function(dirX){return _U.eq(dirX,0)?{ctor:"_Tuple2",_0:$Constants.gameBoundsMaxX,_1:0-$Constants.saucerSpeedX}:{ctor:"_Tuple2",_0:$Constants.gameBoundsMinX,_1:$Constants.saucerSpeedX}},A2($Random.$int,0,2));var Saucer=F7(function(a,b,c,d,e,f,g){return{saucerType:a,position:b,momentum:c,size:d,tickCount:e,tickNextDirectionChange:f,shotAccuracy:g}});var Small={ctor:"Small"};var defaultSaucer={saucerType:Small,position:$Vec2.origin,momentum:$Vec2.origin,size:0,tickCount:0,tickNextDirectionChange:-1,shotAccuracy:0};var Big={ctor:"Big"};var saucerTypeSizeAndAccuracyGenerator=F2(function(score,saucerCount){return A2($Random.map,function(select){var saucerType=_U.cmp(saucerCount,$Constants.initialBigSaucerCount)<1?Big:_U.cmp(score,1e4)>-1?Small:_U.eq(select,0)?Small:Big;var size=$Constants.saucerSizeCollisionRatio*(_U.eq(saucerType,Small)?$Constants.saucerSizeSmall:$Constants.saucerSizeBig);var shotAccuracy=function(){if(_U.eq(saucerType,Small)){var difficulty=A2($Basics.min,1,$Basics.toFloat(score)/$Basics.toFloat($Constants.maxDifficultyScore));return A2(interpolate,$Constants.saucerShotAccuracyRange,difficulty)}else return 0}();return{ctor:"_Tuple3",_0:saucerType,_1:size,_2:shotAccuracy}},A2($Random.$int,0,3))});var newSaucer=F2(function(score,saucerCount){return A5($Random.map4,F4(function(_p19,_p18,_p17,ticks){var _p20=_p19;var _p21=_p18;var _p22=_p17;return{saucerType:_p20._0,position:{x:_p21._0,y:_p22._0},momentum:{x:_p21._1,y:_p22._1},size:_p20._1,tickCount:0,tickNextDirectionChange:ticks,shotAccuracy:_p20._2}}),A2(saucerTypeSizeAndAccuracyGenerator,score,saucerCount),posAndSpeedXGenerator,posAndSpeedYGenerator,A2($Random.$int,$Constants.saucerDirectionTicksMin,$Constants.saucerDirectionTicksMax))});return _elm.Saucer.values={_op:_op,defaultSaucer:defaultSaucer,newSaucer:newSaucer,moveSaucer:moveSaucer,tickSaucer:tickSaucer,maybeFireShot:maybeFireShot,saucerScore:saucerScore,saucerSizeForView:saucerSizeForView,Saucer:Saucer}};Elm.Game=Elm.Game||{};Elm.Game.make=function(_elm){"use strict";_elm.Game=_elm.Game||{};if(_elm.Game.values)return _elm.Game.values;var _U=Elm.Native.Utils.make(_elm),$Asteroid=Elm.Asteroid.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$Explosion=Elm.Explosion.make(_elm),$GameObject=Elm.GameObject.make(_elm),$KeyboardHelpers=Elm.KeyboardHelpers.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$RandomHelpers=Elm.RandomHelpers.make(_elm),$Result=Elm.Result.make(_elm),$Saucer=Elm.Saucer.make(_elm),$Ship=Elm.Ship.make(_elm),$Shot=Elm.Shot.make(_elm),$Signal=Elm.Signal.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var addScore=F2(function(score,game){var score$=game.score+score;var scoreRank=function(x){return $Basics.floor($Basics.toFloat(x)/$Basics.toFloat($Constants.extraLifeMultiple))};var lives=_U.cmp(scoreRank(game.score),scoreRank(score$))<0?game.lives+1:game.lives;return _U.update(game,{score:score$,lives:lives})});var scheduleSaucer=function(game){var _p0=A3($RandomHelpers.randomInt,$Constants.saucerTicksMin,$Constants.saucerTicksMax,game.seed);var ticks=_p0._0;var seed=_p0._1;return _U.update(game,{seed:seed,nextSaucerTickCount:game.tickCount+ticks})};var tickSaucer=function(game){var _p1=game.saucer;if(_p1.ctor==="Just"){var _p2=A2($Saucer.tickSaucer,_p1._0,game.seed);var saucer$=_p2._0;var seed=_p2._1;var _p3=A3($Saucer.maybeFireShot,saucer$,game.ship,seed);var shot=_p3._0;var seed$=_p3._1;var shots=function(){var _p4=shot;if(_p4.ctor==="Just"){return A2($List._op["::"],_p4._0,game.shots)}else{return game.shots}}();return _U.update(game,{saucer:$Maybe.Just(saucer$),seed:seed$,shots:shots})}else{if(_U.eq(game.tickCount,game.nextSaucerTickCount)){var _p5=A2($Random.generate,A2($Saucer.newSaucer,game.score,game.saucerCount),game.seed);var saucer=_p5._0;var seed=_p5._1;return scheduleSaucer(_U.update(game,{saucer:$Maybe.Just(saucer),saucerCount:game.saucerCount+1,seed:seed}))}else return game}};var tickShipState=function(game){var maybeShip=$Ship.tickShipState(game.ship);var ship$=function(){var _p6=maybeShip;if(_p6.ctor==="Just"){return maybeShip}else{return _U.eq(game.lives,0)?$Maybe.Nothing:$Maybe.Just($Ship.invincibleShip)}}();return _U.update(game,{ship:ship$})};var tickExplosions=function(game){return _U.update(game,{explosions:A2($List.filterMap,$Explosion.tickExplosion,game.explosions)})};var addExplosion=F2(function(position,game){var _p7=A2($Explosion.newExplosion,position,game.seed);var explosion=_p7._0;var seed=_p7._1;return _U.update(game,{explosions:A2($List._op["::"],explosion,game.explosions),seed:seed})});var fireShot=function(game){var _p8=$Ship.fireShot(game.ship);if(_p8.ctor==="Nothing"){return game}else{return _U.update(game,{shots:A2($List._op["::"],_p8._0,game.shots)})}};var doSaucerCollision=F4(function(score,_p9,saucer,game){return scheduleSaucer(A2(addScore,score?$Saucer.saucerScore(saucer):0,A2(addExplosion,saucer.position,_U.update(game,{saucer:$Maybe.Nothing}))))});var doShipCollision=F3(function(_p10,ship,game){return _U.eq(ship.status,$Ship.Alive)?A2(addExplosion,ship.position,_U.update(game,{ship:$Maybe.Just($Ship.killShip(ship)),lives:game.lives-1})):game});var doShipSaucerCollision=F3(function(ship,saucer,game){return _U.eq(ship.status,$Ship.Alive)?A4(doSaucerCollision,true,ship,saucer,A3(doShipCollision,saucer,ship,game)):game});var destroyShotAsteroid=F2(function(asteroid,game){if(_U.eq(asteroid.status,$Asteroid.Destroyed)){var score=$Asteroid.asteroidScore(asteroid);var destruction=A2($Asteroid.destroyAsteroid,asteroid,game.seed);var game$=function(){var _p11=destruction;if(_p11.ctor==="Just"){return _U.update(game,{asteroids:A2($List._op["::"],_p11._0._0,A2($List._op["::"],_p11._0._1,game.asteroids)),seed:_p11._0._2})}else{return _U.update(game,{asteroids:game.asteroids})}}();return A2(addScore,score,A2(addExplosion,asteroid.position,game$))}else return _U.update(game,{asteroids:A2($List._op["::"],asteroid,game.asteroids)})});var destroyShotAsteroids=function(game){return A2($List.any,function(asteroid){return _U.eq(asteroid.status,$Asteroid.Destroyed)},game.asteroids)?A3($List.foldr,destroyShotAsteroid,_U.update(game,{asteroids:_U.list([])}),game.asteroids):game};var objectVsObject=F3(function(maybeObjectB,collisionFunction,_p12){var _p13=_p12;var _p19=_p13._0;var _p18=_p13._1;var _p14=_p19;if(_p14.ctor==="Nothing"){return{ctor:"_Tuple2",_0:_p19,_1:_p18}}else{var _p17=_p14._0;var _p15=maybeObjectB;if(_p15.ctor==="Nothing"){return{ctor:"_Tuple2",_0:_p19,_1:_p18}}else{var _p16=_p15._0;return A2($GameObject.collisionTest,_p17,_p16)?{ctor:"_Tuple2",_0:$Maybe.Nothing,_1:A3(collisionFunction,_p17,_p16,_p18)}:{ctor:"_Tuple2",_0:_p19,_1:_p18}}}});var shipVsSaucer=function(game){var _p20=A3(objectVsObject,game.saucer,doShipSaucerCollision,{ctor:"_Tuple2",_0:game.ship,_1:game});var game$=_p20._1;return game$};var objectVsAsteroids=F2(function(object,game){var asteroidCollisionTest=function(asteroid){return _U.eq(asteroid.status,$Asteroid.Active)&&A2($GameObject.collisionTest,object,asteroid)};var tagShotAsteroid=function(asteroid){return asteroidCollisionTest(asteroid)?_U.update(asteroid,{status:$Asteroid.Destroyed}):asteroid};return A2($List.any,asteroidCollisionTest,game.asteroids)?{ctor:"_Tuple2",_0:$Maybe.Nothing,_1:_U.update(game,{asteroids:A2($List.map,tagShotAsteroid,game.asteroids)})}:{ctor:"_Tuple2",_0:$Maybe.Just(object),_1:game}});var gameObjectVsAsteroids=F3(function(maybeObject,collisionFunction,game){var _p21=maybeObject;if(_p21.ctor==="Nothing"){return game}else{var _p24=_p21._0;var _p22=A2(objectVsAsteroids,_p24,game);var object$=_p22._0;var game$=_p22._1;var _p23=object$;if(_p23.ctor==="Just"){return game$}else{return A3(collisionFunction,_p24,_p24,destroyShotAsteroids(game$))}}});var shipVsAsteroids=function(game){var _p25=game.ship;if(_p25.ctor==="Nothing"){return game}else{return _U.eq(_p25._0.status,$Ship.Alive)?A3(gameObjectVsAsteroids,game.ship,doShipCollision,game):game}};var saucerVsAsteroids=function(game){return A3(gameObjectVsAsteroids,game.saucer,doSaucerCollision(false),game)};var shotCollisions=function(game){var shotCollision=F2(function(shot,game$){var _p26=A3(objectVsObject,game$.saucer,doSaucerCollision(true),A3(objectVsObject,game$.ship,doShipCollision,A2(objectVsAsteroids,shot,game$)));var maybeShot=_p26._0;var game$$=_p26._1;var _p27=maybeShot;if(_p27.ctor==="Just"){return _U.update(game$$,{shots:A2($List._op["::"],_p27._0,game$.shots)})}else{return game$$}});var game$=A3($List.foldr,shotCollision,_U.update(game,{shots:_U.list([])}),game.shots);return destroyShotAsteroids(game$)};var checkForOutOfBoundsSaucer=function(game){var _p28=game.saucer;if(_p28.ctor==="Nothing"){return game}else{var _p29=_p28._0;var outOfBounds=_U.cmp(_p29.position.x,$Constants.gameBoundsMinX)<0||_U.cmp(_p29.position.x,$Constants.gameBoundsMaxX)>0;return outOfBounds?scheduleSaucer(_U.update(game,{saucer:$Maybe.Nothing})):game}};var scheduleNewLevel=function(game){return _U.eq(game.asteroids,_U.list([]))&&(_U.eq(game.saucer,$Maybe.Nothing)&&_U.cmp(game.nextLevelTickCount,game.tickCount)<0)?_U.update(game,{nextLevelTickCount:game.tickCount+$Constants.nextLevelDelayTicks,nextSaucerTickCount:0}):game};var moveGameItems=function(game){return _U.update(game,{ship:A2($Ship.moveShip,game.ship,game.arrows),saucer:$Saucer.moveSaucer(game.saucer),shots:A2($List.filterMap,$Shot.tickShot,game.shots),asteroids:A2($List.map,$Asteroid.tickAsteroid,game.asteroids)})};var newLevel=function(game){var asteroidCount=$Constants.startAsteroidCount+game.level*2;var _p30=A2($Random.generate,A2($Random.list,asteroidCount,$Asteroid.newAsteroid),game.seed);var asteroids$=_p30._0;var seed$=_p30._1;return scheduleSaucer(_U.update(game,{asteroids:A2($List.map,$Asteroid.tickAsteroid,asteroids$),seed:seed$,level:game.level+1,tickCount:0,nextLevelTickCount:0,saucer:$Maybe.Nothing}))};var Model=function(a){return function(b){return function(c){return function(d){return function(e){return function(f){return function(g){return function(h){return function(i){return function(j){return function(k){return function(l){return function(m){return function(n){return function(o){return{mode:a,arrows:b,ship:c,saucer:d,shots:e,asteroids:f,explosions:g,score:h,level:i,lives:j,tickCount:k,nextSaucerTickCount:l,nextLevelTickCount:m,saucerCount:n,seed:o}}}}}}}}}}}}}}}};var GameOver={ctor:"GameOver"};var quitGame=function(game){var ship$=function(){var _p31=game.ship;if(_p31.ctor==="Just"){return $Maybe.Just($Ship.killShip(_p31._0))}else{return $Maybe.Nothing}}();return _U.update(game,{mode:GameOver,ship:ship$,lives:0})};var Pause={ctor:"Pause"};var Play={ctor:"Play"};var defaultGame={mode:Play,arrows:$KeyboardHelpers.defaultArrows,ship:$Maybe.Nothing,saucer:$Maybe.Nothing,shots:_U.list([]),asteroids:_U.list([]),explosions:_U.list([]),score:0,level:0,lives:0,tickCount:0,nextSaucerTickCount:0,nextLevelTickCount:0,saucerCount:0,seed:$Random.initialSeed(0)};var newGame=function(game){return newLevel(_U.update(defaultGame,{ship:$Maybe.Just($Ship.newShip),lives:$Constants.startLives,seed:game.seed}))};var changeGameMode=function(game){var _p32=game.mode;switch(_p32.ctor){case"Intro":return newGame(game);case"Play":return _U.update(game,{mode:Pause});case"Pause":return _U.update(game,{mode:Play});default:return newGame(game)}};var hyperspace=function(game){if(_U.eq(game.mode,Play)){var _p33=A2($Ship.goIntoHyperspace,game.ship,game.seed);var ship=_p33._0;var seed=_p33._1;return _U.update(game,{ship:ship,seed:seed})}else return game};var updateArrows=F2(function(game,arrows){return _U.cmp(arrows.y,0)<0?hyperspace(game):_U.update(game,{arrows:arrows})});var Intro={ctor:"Intro"};var newIntro=function(game){var _p34=A2($Random.generate,A2($Random.list,$Constants.introAsteroidCount,$Asteroid.introAsteroid),game.seed);var asteroids=_p34._0;var seed=_p34._1;var _p35=A2($Random.generate,A2($Saucer.newSaucer,0,$Constants.initialBigSaucerCount+1),seed);var saucer=_p35._0;var seed$=_p35._1;return _U.update(defaultGame,{mode:Intro,asteroids:asteroids,saucer:$Maybe.Just(saucer),seed:seed$})};var intro=function(input){var _p36=input;if(_p36.ctor==="StartTime"){return newIntro(_U.update(defaultGame,{seed:$Random.initialSeed($Basics.round(_p36._0))}))}else{return defaultGame}};var checkForNewLevel=function(game){if(_U.eq(game.tickCount,game.nextLevelTickCount)){var _p37=game.mode;if(_p37.ctor==="Intro"){return newIntro(game)}else{return newLevel(game)}}else return game};var checkForGameOver=function(game){return!_U.eq(game.mode,Intro)&&_U.eq(game.ship,$Maybe.Nothing)?_U.update(game,{mode:GameOver}):game};var tickPlay=function(game){return checkForGameOver(scheduleNewLevel(tickSaucer(tickShipState(tickExplosions(saucerVsAsteroids(shipVsAsteroids(shipVsSaucer(shotCollisions(checkForOutOfBoundsSaucer(moveGameItems(checkForNewLevel(_U.update(game,{tickCount:game.tickCount+1})))))))))))))};var tickGame=function(game){return A2($Debug.watch,"Game",function(){var _p38=game.mode;switch(_p38.ctor){case"Intro":return tickPlay(game);case"Play":return tickPlay(game);case"GameOver":return tickPlay(game);default:return game}}())};var updateGame=F2(function(input,game){var _p39=input;switch(_p39.ctor){case"Arrows":return A2(updateArrows,game,_p39._0);case"Wasd":return A2(updateArrows,game,_p39._0);case"Tick":return tickGame(game);case"Space":var _p40=game.mode;if(_p40.ctor==="Play"){return _p39._0?fireShot(game):game}else{return changeGameMode(game)}case"Escape":if(_p39._0){var _p41=game.mode;switch(_p41.ctor){case"Play":return changeGameMode(game);case"Pause":return quitGame(game);default:return game}}else return game;default:return game}});var StartTime=function(a){return{ctor:"StartTime",_0:a}};var Escape=function(a){return{ctor:"Escape",_0:a}};var Space=function(a){return{ctor:"Space",_0:a}};var Tick=function(a){return{ctor:"Tick",_0:a}};var Wasd=function(a){return{ctor:"Wasd",_0:a}};var Arrows=function(a){return{ctor:"Arrows",_0:a}};return _elm.Game.values={_op:_op,intro:intro,updateGame:updateGame,Model:Model,Arrows:Arrows,Wasd:Wasd,Tick:Tick,Space:Space,Escape:Escape,StartTime:StartTime,Intro:Intro,Play:Play,Pause:Pause,GameOver:GameOver}};Elm.Point=Elm.Point||{};Elm.Point.make=function(_elm){"use strict";_elm.Point=_elm.Point||{};if(_elm.Point.values)return _elm.Point.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Debug=Elm.Debug.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Random=Elm.Random.make(_elm),$RandomHelpers=Elm.RandomHelpers.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm);var _op={};var asTuple=function(point){return{ctor:"_Tuple2",_0:point.x,_1:point.y}};var wrapFloat=F3(function(input,min,max){var size=max-min;return _U.cmp(input,min)<0?input+size:_U.cmp(input,max)>-1?input-size:input});var wrapPoint=F3(function(input,min,max){return{x:A3(wrapFloat,input.x,min,max),y:A3(wrapFloat,input.y,min,max)}});var randomPoint=F3(function(seed,min,max){var _p0=A3($RandomHelpers.randomFloat,min,max,seed);var x=_p0._0;var seed0=_p0._1;var _p1=A3($RandomHelpers.randomFloat,min,max,seed0);var y=_p1._0;var seed1=_p1._1;return{ctor:"_Tuple2",_0:{x:x,y:y},_1:seed1}});var defaultPoint={x:0,y:0};var Point=F2(function(a,b){return{x:a,y:b}});return _elm.Point.values={_op:_op,defaultPoint:defaultPoint,randomPoint:randomPoint,wrapPoint:wrapPoint,asTuple:asTuple,Point:Point}};Elm.View=Elm.View||{};Elm.View.make=function(_elm){"use strict";_elm.View=_elm.View||{};if(_elm.View.values)return _elm.View.values;var _U=Elm.Native.Utils.make(_elm),$Asteroid=Elm.Asteroid.make(_elm),$Basics=Elm.Basics.make(_elm),$Color=Elm.Color.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$Explosion=Elm.Explosion.make(_elm),$Game=Elm.Game.make(_elm),$Graphics$Collage=Elm.Graphics.Collage.make(_elm),$Graphics$Element=Elm.Graphics.Element.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Point=Elm.Point.make(_elm),$Result=Elm.Result.make(_elm),$Saucer=Elm.Saucer.make(_elm),$Ship=Elm.Ship.make(_elm),$Shot=Elm.Shot.make(_elm),$Signal=Elm.Signal.make(_elm),$Text=Elm.Text.make(_elm),$Vec2=Elm.Vec2.make(_elm);var _op={};var gameOverText=_U.list(["GAME OVER","","PRESS SPACE TO PLAY AGAIN"]);var pauseText=_U.list(["PAUSED","","PRESS SPACE TO CONTINUE","PRESS ESC TO QUIT"]);var introText=_U.list(["---------","ASTEROIDS","---------","","UP - THRUST","DOWN - HYPERSPACE","LEFT/RIGHT - TURN","SPACE - FIRE","ESC - PAUSE","","PRESS SPACE TO PLAY"]);var textSize=F2(function(string,style){var text=$Graphics$Element.centered(A2($Text.style,style,$Text.fromString(string)));return{ctor:"_Tuple2",_0:$Basics.toFloat($Graphics$Element.widthOf(text)),_1:$Basics.toFloat($Graphics$Element.heightOf(text))}});var textHeight=function(style){var _p0=A2(textSize,"_",style);var height=_p0._1;return height};var textStyle=F2(function(color,height){return{typeface:_U.list(["monospace"]),height:$Maybe.Just(height),color:color,bold:false,italic:false,line:$Maybe.Nothing}});var textColor=A3($Color.rgb,250,250,250);var asteroidPointsCSmall=_U.list([{ctor:"_Tuple2",_0:-1,_1:.8},{ctor:"_Tuple2",_0:-.4,_1:1},{ctor:"_Tuple2",_0:.9,_1:.8},{ctor:"_Tuple2",_0:1,_1:.1},{ctor:"_Tuple2",_0:1,_1:-.4},{ctor:"_Tuple2",_0:.9,_1:-.9},{ctor:"_Tuple2",_0:.2,_1:-1},{ctor:"_Tuple2",_0:0,_1:-.7},{ctor:"_Tuple2",_0:-.333,_1:-1},{ctor:"_Tuple2",_0:-.7,_1:-1},{ctor:"_Tuple2",_0:-1,_1:-.333},{ctor:"_Tuple2",_0:-.8,_1:.333}]);var asteroidPointsC=_U.list([{ctor:"_Tuple2",_0:-1,_1:.8},{ctor:"_Tuple2",_0:-.4,_1:1},{ctor:"_Tuple2",_0:.2,_1:.8},{ctor:"_Tuple2",_0:.6,_1:1},{ctor:"_Tuple2",_0:.7,_1:1},{ctor:"_Tuple2",_0:.9,_1:.8},{ctor:"_Tuple2",_0:1,_1:.1},{ctor:"_Tuple2",_0:.9,_1:-.25},{ctor:"_Tuple2",_0:1,_1:-.4},{ctor:"_Tuple2",_0:.9,_1:-.9},{ctor:"_Tuple2",_0:.5,_1:-1},{ctor:"_Tuple2",_0:.2,_1:-1},{ctor:"_Tuple2",_0:0,_1:-.8},{ctor:"_Tuple2",_0:-.333,_1:-1},{ctor:"_Tuple2",_0:-.7,_1:-1},{ctor:"_Tuple2",_0:-.95,_1:-.4},{ctor:"_Tuple2",_0:-1,_1:-.333},{ctor:"_Tuple2",_0:-.8,_1:.1},{ctor:"_Tuple2",_0:-1,_1:.333}]);var asteroidPointsB=_U.list([{ctor:"_Tuple2",_0:-1,_1:.5},{ctor:"_Tuple2",_0:-.2,_1:.5},{ctor:"_Tuple2",_0:-.5,_1:1},{ctor:"_Tuple2",_0:.2,_1:1},{ctor:"_Tuple2",_0:1,_1:.5},{ctor:"_Tuple2",_0:1,_1:.3},{ctor:"_Tuple2",_0:.4,_1:0},{ctor:"_Tuple2",_0:1,_1:-.5},{ctor:"_Tuple2",_0:.4,_1:-1},{ctor:"_Tuple2",_0:.2,_1:-.7},{ctor:"_Tuple2",_0:-.5,_1:-1},{ctor:"_Tuple2",_0:-1,_1:-.3}]);var asteroidPointsA=_U.list([{ctor:"_Tuple2",_0:-1,_1:.5},{ctor:"_Tuple2",_0:-.5,_1:1},{ctor:"_Tuple2",_0:0,_1:.7},{ctor:"_Tuple2",_0:.5,_1:1},{ctor:"_Tuple2",_0:1,_1:.5},{ctor:"_Tuple2",_0:.8,_1:0},{ctor:"_Tuple2",_0:1,_1:-.5},{ctor:"_Tuple2",_0:.3,_1:-1},{ctor:"_Tuple2",_0:-.5,_1:-1},{ctor:"_Tuple2",_0:-1,_1:-.6}]);var asteroidPoints=function(asteroid){var _p1=asteroid.kind;switch(_p1.ctor){case"A":return asteroidPointsA;case"B":return asteroidPointsB;default:var _p2=asteroid.sizeClass;if(_p2.ctor==="Small"){return asteroidPointsCSmall}else{return asteroidPointsC}}};var scalePoints=F2(function(path,factor){return A2($List.map,function(_p3){var _p4=_p3;return{ctor:"_Tuple2",_0:_p4._0*factor,_1:_p4._1*factor}},path)});var renderObjects=F3(function(list,renderFunction,factor){return $Graphics$Collage.group(A2($List.map,function(object){return A2(renderFunction,object,factor)},list))});var shotRadius=.15;var shipHeight=1/2;var crossBarY=0-shipHeight+shipHeight/3;var flameOffset=shipHeight/4;var flameY=crossBarY-flameOffset;var flameY2=0-shipHeight-flameOffset;var shipWidth=.6/2;var crossBarX=shipWidth*2/3;var flameX=crossBarX*.75;var thrustPoints=_U.list([{ctor:"_Tuple2",_0:0-flameX,_1:flameY},{ctor:"_Tuple2",_0:flameX,_1:flameY},{ctor:"_Tuple2",_0:0,_1:flameY2}]);var shipPoints=_U.list([{ctor:"_Tuple2",_0:0-shipWidth,_1:0-shipHeight},{ctor:"_Tuple2",_0:0,_1:shipHeight},{ctor:"_Tuple2",_0:shipWidth,_1:0-shipHeight},{ctor:"_Tuple2",_0:crossBarX,_1:crossBarY},{ctor:"_Tuple2",_0:0-crossBarX,_1:crossBarY}]);var scaleTuple=F2(function(_p5,factor){var _p6=_p5;return{ctor:"_Tuple2",_0:_p6._0*factor,_1:_p6._1*factor}});var asteroidColor=A3($Color.rgb,255,255,255);var asteroidLineStyle=_U.update($Graphics$Collage.defaultLine,{color:asteroidColor});var renderAsteroid=F2(function(asteroid,factor){var size=factor*asteroid.size;return A2($Graphics$Collage.rotate,asteroid.angle,A2($Graphics$Collage.move,A2(scaleTuple,$Point.asTuple(asteroid.position),factor),A2($Graphics$Collage.outlined,asteroidLineStyle,$Graphics$Collage.polygon(A2(scalePoints,asteroidPoints(asteroid),size)))))});var renderExplosion=F2(function(explosion,factor){var debrisSize=factor*$Constants.debrisSize;var progress=$Basics.toFloat(explosion.tickCount)/$Basics.toFloat($Constants.explosionLifetime);var size=factor*progress*$Constants.explosionSize;var renderDebris=function(position){return A2($Graphics$Collage.move,A2(scaleTuple,position,debrisSize*size),A2($Graphics$Collage.outlined,asteroidLineStyle,$Graphics$Collage.square(debrisSize)))};var debris=A2($List.map,renderDebris,_U.list([{ctor:"_Tuple2",_0:.8,_1:.3},{ctor:"_Tuple2",_0:.1,_1:.3},{ctor:"_Tuple2",_0:.5,_1:.6},{ctor:"_Tuple2",_0:.5,_1:-.2},{ctor:"_Tuple2",_0:.2,_1:-.4},{ctor:"_Tuple2",_0:.6,_1:-.9},{ctor:"_Tuple2",_0:-1,_1:-.3},{ctor:"_Tuple2",_0:-.8,_1:-.3},{ctor:"_Tuple2",_0:-.2,_1:-.6},{ctor:"_Tuple2",_0:-.5,_1:.6},{ctor:"_Tuple2",_0:-.9,_1:.7},{ctor:"_Tuple2",_0:-.4,_1:.3}]));return A2($Graphics$Collage.rotate,explosion.angle,A2($Graphics$Collage.move,A2(scaleTuple,$Point.asTuple(explosion.position),factor),$Graphics$Collage.group(debris)))});var shipColor=A3($Color.rgb,255,255,255);var renderShot=F2(function(shot,factor){return A2($Graphics$Collage.move,A2(scaleTuple,$Point.asTuple(shot.position),factor),A2($Graphics$Collage.filled,shipColor,$Graphics$Collage.square(shotRadius*$Constants.shipSize*factor)))});var shipLineStyle=_U.update($Graphics$Collage.defaultLine,{color:shipColor,join:$Graphics$Collage.Clipped});var renderLiveShip=F2(function(ship,factor){var showThrust=ship.thrust&&_U.eq(A2($Basics._op["%"],ship.tickCount,3),0);var points=showThrust?_U.list([shipPoints,thrustPoints]):_U.list([shipPoints]);
var lineStyle=shipLineStyle;var shipSize=$Constants.shipSize*factor;var shipTransform=function(points){return A2($Graphics$Collage.outlined,lineStyle,$Graphics$Collage.polygon(A2(scalePoints,points,shipSize)))};var shipShape=A2($List.map,shipTransform,points);var shipPosition=A2(scaleTuple,$Point.asTuple(ship.position),factor);return A2($Graphics$Collage.rotate,ship.angle,A2($Graphics$Collage.move,shipPosition,$Graphics$Collage.group(shipShape)))});var renderShipDebris=F2(function(ship,factor){var shipSize=$Constants.shipSize*factor;var progress=$Basics.toFloat(ship.tickCount)/$Basics.toFloat($Constants.deadShipTicks)+.5;var debrisSize=progress*$Constants.shipDebrisSize*factor;var renderDebris=function(_p7){var _p8=_p7;var _p9=_p8._0;return A2($Graphics$Collage.move,$Point.asTuple(A2($Vec2.rotate,_p8._2,{x:0,y:debrisSize})),A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:_p8._3*shipSize,_1:_p8._4*shipSize},A2($Graphics$Collage.rotate,_p8._1,A2($Graphics$Collage.traced,shipLineStyle,A2($Graphics$Collage.segment,A2(scaleTuple,{ctor:"_Tuple2",_0:0,_1:-.5},_p9*shipSize),A2(scaleTuple,{ctor:"_Tuple2",_0:0,_1:.5},_p9*shipSize))))))};var debris=A2($List.map,renderDebris,_U.list([{ctor:"_Tuple5",_0:.45,_1:$Basics.pi/8,_2:(0-$Basics.pi)/6,_3:-.05,_4:.15},{ctor:"_Tuple5",_0:.5,_1:$Basics.pi/12,_2:(0-$Basics.pi)/3,_3:-.05,_4:-.35},{ctor:"_Tuple5",_0:.5,_1:(0-$Basics.pi)/8,_2:$Basics.pi/6,_3:.05,_4:.15},{ctor:"_Tuple5",_0:.45,_1:(0-$Basics.pi)/12,_2:$Basics.pi/3,_3:.05,_4:-.35},{ctor:"_Tuple5",_0:.4,_1:$Basics.pi/2,_2:$Basics.pi,_3:0,_4:0}]));return A2($Graphics$Collage.rotate,ship.angle,A2($Graphics$Collage.move,A2(scaleTuple,$Point.asTuple(ship.position),factor),$Graphics$Collage.group(debris)))});var renderShip=F2(function(maybeShip,factor){var _p10=maybeShip;if(_p10.ctor==="Just"){var _p13=_p10._0;var _p11=_p13.status;if(_p11.ctor==="Dead"){return A2(renderShipDebris,_p13,factor)}else{var showShip=function(){var _p12=_p13.status;switch(_p12.ctor){case"Alive":return true;case"Invincible":return _U.cmp(A2($Basics._op["%"],_p13.tickCount,20),10)<0;default:return false}}();return showShip?A2(renderLiveShip,_p13,factor):$Graphics$Collage.group(_U.list([]))}}else{return $Graphics$Collage.group(_U.list([]))}});var renderLives=F4(function(lives,factor,width,height){var shipSize=$Constants.lifeSize*factor;var ship=A2($Graphics$Collage.traced,shipLineStyle,$Graphics$Collage.path(A2(scalePoints,shipPoints,shipSize)));var ships=A2($List.indexedMap,F2(function(i,ship$){return A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:$Basics.toFloat(i)*shipSize,_1:0},ship)}),A2($List.repeat,lives,ship));return A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:(0-width)/2+shipSize,_1:height/2-shipSize},$Graphics$Collage.group(ships))});var renderSaucer=F2(function(maybeSaucer,factor){var _p14=maybeSaucer;if(_p14.ctor==="Nothing"){return $Graphics$Collage.group(_U.list([]))}else{var _p15=_p14._0;var outlinePoints=_U.list([{ctor:"_Tuple2",_0:-.5,_1:0},{ctor:"_Tuple2",_0:-.1667,_1:.23},{ctor:"_Tuple2",_0:-.08,_1:.4},{ctor:"_Tuple2",_0:.08,_1:.4},{ctor:"_Tuple2",_0:.1667,_1:.23},{ctor:"_Tuple2",_0:.5,_1:0},{ctor:"_Tuple2",_0:.2,_1:-.2},{ctor:"_Tuple2",_0:-.2,_1:-.2}]);var saucerSize=$Saucer.saucerSizeForView(_p15)*factor;var saucerTransform=function(path){return A2($Graphics$Collage.outlined,shipLineStyle,$Graphics$Collage.polygon(A2(scalePoints,path,saucerSize)))};var saucerShapes=A2($List.map,saucerTransform,_U.list([outlinePoints,_U.list([{ctor:"_Tuple2",_0:-.5,_1:0},{ctor:"_Tuple2",_0:.5,_1:0}]),_U.list([{ctor:"_Tuple2",_0:-.1667,_1:.23},{ctor:"_Tuple2",_0:.1667,_1:.23}])]));return A2($Graphics$Collage.move,A2(scaleTuple,$Point.asTuple(_p15.position),factor),$Graphics$Collage.group(saucerShapes))}});var styledText=F2(function(style,string){return A2($Graphics$Collage.outlinedText,shipLineStyle,A2($Text.style,style,$Text.fromString(string)))});var scoreText=F4(function(score,width,height,factor){var style=A2(textStyle,textColor,$Constants.scoreTextHeight*factor);var scoreString=$Basics.toString(score);var _p16=A2(textSize,scoreString,style);var textWidth=_p16._0;var textHeight=_p16._1;var xOffset=width/2-textWidth/2-$Constants.scoreTextHeight*factor/3;var yOffset=height/2-textHeight/2+$Constants.scoreTextHeight*factor/10;return A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:xOffset,_1:yOffset},A2(styledText,style,scoreString))});var renderGameText=F2(function(mode,factor){if(_U.eq(mode,$Game.Play))return $Graphics$Collage.group(_U.list([]));else{var lines=function(){var _p17=mode;switch(_p17.ctor){case"Intro":return introText;case"Pause":return pauseText;case"GameOver":return gameOverText;default:return _U.list([])}}();var lineCount=$List.length(lines);var centerLine=($Basics.toFloat(lineCount)-1)/2;var style=A2(textStyle,textColor,$Constants.gameTextHeight*factor);var yOffset=textHeight(style)+$Constants.gameTextHeight*factor/5;var renderLine=F2(function(index,text){var lineOffset=($Basics.toFloat(index)-centerLine)*(0-yOffset);var line=A2(styledText,style,text);return A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:0,_1:lineOffset},line)});return $Graphics$Collage.group(A2($List.indexedMap,renderLine,lines))}});var borderColor=A3($Color.rgb,255,255,255);var borderLineStyle=_U.update($Graphics$Collage.defaultLine,{color:borderColor,width:2});var backgroundColor=A3($Color.rgb,0,0,0);var view=F2(function(_p18,game){var _p19=_p18;var _p24=_p19._0;var _p23=_p19._1;var _p20={ctor:"_Tuple2",_0:$Basics.toFloat(_p24),_1:$Basics.toFloat(_p23)};var w$=_p20._0;var h$=_p20._1;var factor=A2($Basics.min,w$,h$)-2;var _p21={ctor:"_Tuple2",_0:$Constants.gameWidth*factor,_1:$Constants.gameHeight*factor};var width=_p21._0;var height=_p21._1;var background=A2($Graphics$Collage.filled,backgroundColor,A2($Graphics$Collage.rect,width,height));var border=A2($Graphics$Collage.move,{ctor:"_Tuple2",_0:0,_1:0},A2($Graphics$Collage.outlined,borderLineStyle,A2($Graphics$Collage.rect,width,height)));var score=function(){var _p22=game.mode;if(_p22.ctor==="Intro"){return $Graphics$Collage.group(_U.list([]))}else{return A4(scoreText,game.score,width,height,factor)}}();return A2($Graphics$Element.color,backgroundColor,A4($Graphics$Element.container,_p24,_p23,$Graphics$Element.middle,A3($Graphics$Collage.collage,$Basics.floor(width),$Basics.floor(height),_U.list([background,A2(renderShip,game.ship,factor),A4(renderLives,game.lives,factor,width,height),A2(renderSaucer,game.saucer,factor),A3(renderObjects,game.shots,renderShot,factor),A3(renderObjects,game.asteroids,renderAsteroid,factor),A3(renderObjects,game.explosions,renderExplosion,factor),border,score,A2(renderGameText,game.mode,factor)]))))});var backgroundLineStyle=_U.update($Graphics$Collage.defaultLine,{color:backgroundColor});return _elm.View.values={_op:_op,view:view}};Elm.Main=Elm.Main||{};Elm.Main.make=function(_elm){"use strict";_elm.Main=_elm.Main||{};if(_elm.Main.values)return _elm.Main.values;var _U=Elm.Native.Utils.make(_elm),$Basics=Elm.Basics.make(_elm),$Constants=Elm.Constants.make(_elm),$Debug=Elm.Debug.make(_elm),$Game=Elm.Game.make(_elm),$Graphics$Element=Elm.Graphics.Element.make(_elm),$Keyboard=Elm.Keyboard.make(_elm),$List=Elm.List.make(_elm),$Maybe=Elm.Maybe.make(_elm),$Result=Elm.Result.make(_elm),$Signal=Elm.Signal.make(_elm),$Signal$Extra=Elm.Signal.Extra.make(_elm),$Signal$Time=Elm.Signal.Time.make(_elm),$Time=Elm.Time.make(_elm),$View=Elm.View.make(_elm),$Window=Elm.Window.make(_elm);var _op={};var updateSignal=$Signal.mergeMany(_U.list([A2($Signal.map,$Game.StartTime,$Signal$Time.startTime),A2($Signal.map,$Game.Tick,$Time.fps($Constants.tickFps)),A2($Signal.map,$Game.Arrows,$Keyboard.arrows),A2($Signal.map,$Game.Wasd,$Keyboard.wasd),A2($Signal.map,$Game.Space,$Keyboard.space),A2($Signal.map,$Game.Escape,$Keyboard.isDown(27))]));var gameSignal=A3($Signal$Extra.foldp$,$Game.updateGame,$Game.intro,updateSignal);var main=A3($Signal.map2,$View.view,$Window.dimensions,gameSignal);return _elm.Main.values={_op:_op,main:main}};
